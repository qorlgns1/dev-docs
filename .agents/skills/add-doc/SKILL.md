...
이 단계에서 홈 페이지 `src/content/docs/index.md`도 현재 섹션 목록 기준으로 자동 갱신됩니다.
...
`src/config/sidebar.generated.json`과 `src/content/docs/index.md` 변경분도 함께 커밋됩니다.
Vercel이 push에 반응해 자동 배포합니다.
