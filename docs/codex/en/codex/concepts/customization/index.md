...
MCP (Model Context Protocol) is the standard way to connect Codex to external tools and context providers. It’s especially useful for remotely hosted systems such as Figma, Linear, Jira, GitHub, or internal knowledge services your team depends on.
