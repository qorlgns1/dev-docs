...
description: "Vite 플러그인으로 Tailwind CSS를 설치하는 것은 Laravel, SvelteKit, React Router, Nuxt, SolidJS 같은 프레임워크와 통합하는 가장 매끄러운 방법입니다."
---

출처 URL: https://tailwindcss.com/docs
...
Vite 플러그인으로 Tailwind CSS를 설치하는 것은 Laravel, SvelteKit, React Router, Nuxt, SolidJS 같은 프레임워크와 통합하는 가장 매끄러운 방법입니다.

01

#### 프로젝트 생성

아직 설정된 프로젝트가 없다면 먼저 새 Vite 프로젝트를 만드세요. 가장 일반적인 방법은 [Create Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project)를 사용하는 것입니다.
...
컴파일된 CSS가 `<head>`에 포함되어 있는지 확인한 다음 _(프레임워크가 이 작업을 대신 처리해 줄 수도 있습니다)_ Tailwind의 유틸리티 클래스를 사용해 콘텐츠 스타일링을 시작하세요.
...
**막히셨나요?** Tailwind를 Vite와 함께 설정하는 방식은 빌드 도구마다 조금씩 다를 수 있습니다. 현재 구성에 맞는 더 구체적인 안내가 있는지 프레임워크 가이드를 확인해 보세요.
