---
title: "Rspack에서 Tailwind CSS 설치 - Tailwind CSS"
description: "아직 설정된 프로젝트가 없다면 새 Rspack 프로젝트를 먼저 생성하세요. 가장 일반적인 방법은 Rspack CLI를 사용하는 것입니다."
---

출처 URL: https://tailwindcss.com/docs/installation/framework-guides/rspack/react

# Rspack에서 Tailwind CSS 설치 - Tailwind CSS
...
아직 설정된 프로젝트가 없다면 새 Rspack 프로젝트를 먼저 생성하세요. 가장 일반적인 방법은 [Rspack CLI](https://rspack.dev/guide/start/quick-start#using-the-rspack-cli)를 사용하는 것입니다.
...
`@tailwindcss/postcss`와 해당 피어 의존성을 설치하세요.
