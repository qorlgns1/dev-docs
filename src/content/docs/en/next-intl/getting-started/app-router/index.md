---
title: 'Next.js App Router internationalization (i18n)'
description: 'DocsGetting startedApp Router'
---

Source URL: https://next-intl.dev/docs/getting-started/app-router

Docs[Getting started](https://next-intl.dev/docs/getting-started "Getting started")App Router
...
## Getting started[](https://next-intl.dev/docs/getting-started/app-router#getting-started)
...
[](https://next-intl.dev/docs/getting-started/app-router#i18n-request-path)Can I move this file somewhere else?
...
## Next steps[](https://next-intl.dev/docs/getting-started/app-router#next-steps)

### Locale-based routing[](https://next-intl.dev/docs/getting-started/app-router#locale-based-routing)
...
### Provide a locale[](https://next-intl.dev/docs/getting-started/app-router#provide-a-locale)
...
### Internationalization isn’t just translating words[](https://next-intl.dev/docs/getting-started/app-router#internationalization-isnt-just-translating-words)
...
[![Video preview](https://next-intl.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fthumb.06bfa870.jpg&w=384&q=75)](https://learn.next-intl.dev)
