...
description: '> This API has been replaced by  in Next.js 16.'
---
...
> **Note:**
> This API has been replaced by [`use cache`](https://nextjs.org/docs/app/api-reference/directives/use-cache) in Next.js 16.
> We recommend opting into [Cache Components](https://nextjs.org/docs/app/getting-started/cache-components) and replacing `unstable_cache` with the `use cache` directive.
