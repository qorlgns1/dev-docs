...
### [generateSitemapsLearn how to use the generateSiteMaps function to create multiple sitemaps for your application.](https://nextjs.org/docs/app/api-reference/functions/generate-sitemaps)
