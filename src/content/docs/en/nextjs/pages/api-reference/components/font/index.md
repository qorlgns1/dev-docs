...
A string value to define the CSS variable name to be used if the style is applied with the [CSS variable method](https://nextjs.org/docs/pages/api-reference/components/font#css-variables).
...
## Examples[](https://nextjs.org/docs/pages/api-reference/components/font#examples)
...
### Apply the font in `<head>`[](https://nextjs.org/docs/pages/api-reference/components/font#apply-the-font-in-head)
...
### Single page usage[](https://nextjs.org/docs/pages/api-reference/components/font#single-page-usage)
...
### Specifying a subset[](https://nextjs.org/docs/pages/api-reference/components/font#specifying-a-subset)
...
## Using Multiple Fonts[](https://nextjs.org/docs/pages/api-reference/components/font#using-multiple-fonts)
...
### Local Fonts[](https://nextjs.org/docs/pages/api-reference/components/font#local-fonts)
...
### With Tailwind CSS[](https://nextjs.org/docs/pages/api-reference/components/font#with-tailwind-css)
...
### Applying Styles[](https://nextjs.org/docs/pages/api-reference/components/font#applying-styles)
...
### Using a font definitions file[](https://nextjs.org/docs/pages/api-reference/components/font#using-a-font-definitions-file)
...
### Preloading[](https://nextjs.org/docs/pages/api-reference/components/font#preloading)
...
## Version Changes[](https://nextjs.org/docs/pages/api-reference/components/font#version-changes)
