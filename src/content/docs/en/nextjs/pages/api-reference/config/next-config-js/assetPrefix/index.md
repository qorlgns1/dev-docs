...
> **Attention** : [Deploying to Vercel](https://nextjs.org/docs/pages/getting-started/deploying) automatically configures a global CDN for your Next.js project. You do not need to manually setup an Asset Prefix.
