---
title: 'next.config.js Options: turbopack'
...
# next.config.js Options: turbopack | Next.js

Source URL: https://nextjs.org/docs/pages/api-reference/config/next-config-js/turbopack
