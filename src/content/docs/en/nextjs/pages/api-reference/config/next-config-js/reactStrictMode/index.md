...
description: '> Good to know: Since Next.js 13.5.1, Strict Mode is  by default with  router, so the above configuration is only necessary for . You can still disabl...'
---

Source URL: https://nextjs.org/docs/pages/api-reference/config/next-config-js/reactStrictMode
