...
You can also enable IE11 support for [CSS Grid Layout](https://developer.mozilla.org/docs/Web/CSS/grid) in your entire project by configuring autoprefixer with the configuration shown below (collapsed). See ["Customizing Plugins"](https://nextjs.org/docs/pages/guides/post-css#customizing-plugins) below for more information.
