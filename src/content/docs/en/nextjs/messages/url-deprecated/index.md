...
description: 'In versions prior to 6.x the  property got magically injected into every  component (every page inside the  directory).'
---

# `url` is deprecated | Next.js
