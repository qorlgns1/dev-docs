---
title: "Twitter"
description: "Twitter is currently the only built-in provider using the OAuth 1.0 spec. This means that you won't receive an  or , but an  and  respectively. Rememb..."
---

Source URL: https://next-auth.js.org/providers/twitter
...
## Documentation[​](https://next-auth.js.org/providers/twitter#documentation "Direct link to heading")

<https://developer.twitter.com>

## Configuration[​](https://next-auth.js.org/providers/twitter#configuration "Direct link to heading")

<https://developer.twitter.com/en/apps>

## Options[​](https://next-auth.js.org/providers/twitter#options "Direct link to heading")
...
## Example[​](https://next-auth.js.org/providers/twitter#example "Direct link to heading")
