---
title: "Trakt"
description: "If you're using the api in production by calling api.trakt.tv. Follow the example below. If you wish to develop on Trakt's sandbox environment by call..."
---
...
## Documentation[​](https://next-auth.js.org/providers/trakt#documentation "Direct link to heading")

<https://trakt.docs.apiary.io/#reference/authentication-oauth>

## Configuration[​](https://next-auth.js.org/providers/trakt#configuration "Direct link to heading")
...
## Options[​](https://next-auth.js.org/providers/trakt#options "Direct link to heading")
...
## Example[​](https://next-auth.js.org/providers/trakt#example "Direct link to heading")
