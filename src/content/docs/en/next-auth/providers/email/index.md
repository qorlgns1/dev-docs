---
title: "Email"
description: 'The Email provider uses email to send "magic links" that can be used to sign in, you will likely have seen these if you have used services like Slack ...'
---
...
## Overview[​](https://next-auth.js.org/providers/email#overview "Direct link to heading")
...
### How it works[​](https://next-auth.js.org/providers/email#how-it-works "Direct link to heading")
...
## Options[​](https://next-auth.js.org/providers/email#options "Direct link to heading")
...
## Configuration[​](https://next-auth.js.org/providers/email#configuration "Direct link to heading")
...
## Customizing emails[​](https://next-auth.js.org/providers/email#customizing-emails "Direct link to heading")
...
## Customizing the Verification Token[​](https://next-auth.js.org/providers/email#customizing-the-verification-token "Direct link to heading")
...
## Normalizing the email address[​](https://next-auth.js.org/providers/email#normalizing-the-email-address "Direct link to heading")
...
## Sending Magic Links To Existing Users[​](https://next-auth.js.org/providers/email#sending-magic-links-to-existing-users "Direct link to heading")
