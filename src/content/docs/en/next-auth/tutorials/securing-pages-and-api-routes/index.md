...
Source URL: https://next-auth.js.org/tutorials/securing-pages-and-api-routes
...
## Securing Pages[​](https://next-auth.js.org/tutorials/securing-pages-and-api-routes#securing-pages "Direct link to heading")

### Client Side[​](https://next-auth.js.org/tutorials/securing-pages-and-api-routes#client-side "Direct link to heading")
...
### Next.js (Middleware)[​](https://next-auth.js.org/tutorials/securing-pages-and-api-routes#nextjs-middleware "Direct link to heading")
...
### Server Side[​](https://next-auth.js.org/tutorials/securing-pages-and-api-routes#server-side "Direct link to heading")
...
## Securing API Routes[​](https://next-auth.js.org/tutorials/securing-pages-and-api-routes#securing-api-routes "Direct link to heading")

### Using getServerSession()[​](https://next-auth.js.org/tutorials/securing-pages-and-api-routes#using-getserversession "Direct link to heading")
...
### Using getToken()[​](https://next-auth.js.org/tutorials/securing-pages-and-api-routes#using-gettoken "Direct link to heading")
