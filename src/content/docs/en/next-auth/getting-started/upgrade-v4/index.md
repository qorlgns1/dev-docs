...
description: "NextAuth.js version 4 includes a few breaking changes from the last major version (3.x). So we're here to help you upgrade your applications as smooth..."
---

Source URL: https://next-auth.js.org/getting-started/upgrade-v4
...
## Providers[​](https://next-auth.js.org/getting-started/upgrade-v4#providers "Direct link to heading")
...
For more details on their usage, please see [options](https://next-auth.js.org/configuration/providers/oauth#options) section of the OAuth Provider documentation.
...
Implemented in: [#2411](https://github.com/nextauthjs/next-auth/pull/2411) Introduced in <https://github.com/nextauthjs/next-auth/releases/tag/v4.0.0-next.20>

## `useSession` Hook[​](https://next-auth.js.org/getting-started/upgrade-v4#usesession-hook "Direct link to heading")
...
## Named Parameters[​](https://next-auth.js.org/getting-started/upgrade-v4#named-parameters "Direct link to heading")
...
### Callbacks[​](https://next-auth.js.org/getting-started/upgrade-v4#callbacks "Direct link to heading")
...
### Events[​](https://next-auth.js.org/getting-started/upgrade-v4#events "Direct link to heading")
...
## JWT configuration[​](https://next-auth.js.org/getting-started/upgrade-v4#jwt-configuration "Direct link to heading")

We have removed some of the [configuration options](https://next-auth.js.org/configuration/options) when using JSON Web Tokens, [here's the PR](https://github.com/nextauthjs/next-auth/pull/3039) for more context.
...
## Logger API[​](https://next-auth.js.org/getting-started/upgrade-v4#logger-api "Direct link to heading")
...
Like `typeorm` and `prisma`, [`nodemailer`](https://npmjs.com/package/nodemailer) is no longer included as a dependency by default. If you are using the Email provider you must install it in your project manually, or use any other Email library in the [`sendVerificationRequest`](https://next-auth.js.org/configuration/providers/email#options-1#:~:text=sendVerificationRequest) callback. This reduces bundle size for those not actually using the Email provider. Remember, when using the Email provider, it is mandatory to also use a database adapter due to the fact that verification tokens need to be persisted longer term for the magic link functionality to work.

Introduced in <https://github.com/nextauthjs/next-auth/releases/tag/v4.0.0-next.2>

## Theme[​](https://next-auth.js.org/getting-started/upgrade-v4#theme "Direct link to heading")
...
## Session[​](https://next-auth.js.org/getting-started/upgrade-v4#session "Direct link to heading")
...
## Adapters[​](https://next-auth.js.org/getting-started/upgrade-v4#adapters "Direct link to heading")
...
### Adapter API[​](https://next-auth.js.org/getting-started/upgrade-v4#adapter-api "Direct link to heading")
...
### Schema changes[​](https://next-auth.js.org/getting-started/upgrade-v4#schema-changes "Direct link to heading")
...
### Database migration[​](https://next-auth.js.org/getting-started/upgrade-v4#database-migration "Direct link to heading")
...
## Missing `secret`[​](https://next-auth.js.org/getting-started/upgrade-v4#missing-secret "Direct link to heading")
...
## Summary[​](https://next-auth.js.org/getting-started/upgrade-v4#summary "Direct link to heading")
