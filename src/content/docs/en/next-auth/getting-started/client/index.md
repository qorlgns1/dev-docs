---
title: "Client API"
description: "The NextAuth.js client library makes it easy to interact with sessions from React applications."
---
...
#### Example Session Object[​](https://next-auth.js.org/getting-started/client#example-session-object "Direct link to heading")
...
The `expires` value is rotated, meaning whenever the session is retrieved from the [REST API](https://next-auth.js.org/getting-started/rest-api), this value will be updated as well, to avoid session expiry.

---

## useSession()[​](https://next-auth.js.org/getting-started/client#usesession "Direct link to heading")
...
#### Example[​](https://next-auth.js.org/getting-started/client#example "Direct link to heading")
...
### Require session[​](https://next-auth.js.org/getting-started/client#require-session "Direct link to heading")
...
#### Example[​](https://next-auth.js.org/getting-started/client#example-1 "Direct link to heading")
...
### Custom Client Session Handling[​](https://next-auth.js.org/getting-started/client#custom-client-session-handling "Direct link to heading")
...
### Updating the session[​](https://next-auth.js.org/getting-started/client#updating-the-session "Direct link to heading")
...
#### Example[​](https://next-auth.js.org/getting-started/client#example-2 "Direct link to heading")
...
### Refetching the session[​](https://next-auth.js.org/getting-started/client#refetching-the-session "Direct link to heading")

[`SessionProvider#refetchInterval`](https://next-auth.js.org/getting-started/client#refetch-interval) and [`SessionProvider#refetchOnWindowFocus`](https://next-auth.js.org/getting-started/client#refetch-on-window-focus) can be replaced with the `update()` method too.
...
## getSession()[​](https://next-auth.js.org/getting-started/client#getsession "Direct link to heading")

- Client Side: **Yes**
- Server Side: **No** (See: [`getServerSession()`](https://next-auth.js.org/configuration/nextjs#getserversession)
...
Read the tutorial [securing pages and API routes](https://next-auth.js.org/tutorials/securing-pages-and-api-routes) to know how to fetch the session in server side calls using `getServerSession()`.

---

## getCsrfToken()[​](https://next-auth.js.org/getting-started/client#getcsrftoken "Direct link to heading")
...
#### Client Side Example[​](https://next-auth.js.org/getting-started/client#client-side-example "Direct link to heading")
...
#### Server Side Example[​](https://next-auth.js.org/getting-started/client#server-side-example "Direct link to heading")
...
## getProviders()[​](https://next-auth.js.org/getting-started/client#getproviders "Direct link to heading")
...
#### API Route[​](https://next-auth.js.org/getting-started/client#api-route "Direct link to heading")
...
## signIn()[​](https://next-auth.js.org/getting-started/client#signin "Direct link to heading")
...
### Redirects to sign in page when clicked[​](https://next-auth.js.org/getting-started/client#redirects-to-sign-in-page-when-clicked "Direct link to heading")
...
### Starts OAuth sign-in flow when clicked[​](https://next-auth.js.org/getting-started/client#starts-oauth-sign-in-flow-when-clicked "Direct link to heading")
...
### Starts Email sign-in flow when clicked[​](https://next-auth.js.org/getting-started/client#starts-email-sign-in-flow-when-clicked "Direct link to heading")
...
### Specifying a `callbackUrl`[​](https://next-auth.js.org/getting-started/client#specifying-a-callbackurl "Direct link to heading")
...
The URL must be considered valid by the [redirect callback handler](https://next-auth.js.org/configuration/callbacks#redirect-callback). By default it requires the URL to be an absolute URL at the same host name, or a relative url starting with a slash. If it does not match it will redirect to the homepage. You can define your own [redirect callback](https://next-auth.js.org/configuration/callbacks#redirect-callback) to allow other URLs.

### Using the `redirect: false` option[​](https://next-auth.js.org/getting-started/client#using-the-redirect-false-option "Direct link to heading")
...
### Additional parameters[​](https://next-auth.js.org/getting-started/client#additional-parameters "Direct link to heading")
...
You can also set these parameters through [`provider.authorizationParams`](https://next-auth.js.org/configuration/providers/oauth#options).
...
### Specifying a `callbackUrl`[​](https://next-auth.js.org/getting-started/client#specifying-a-callbackurl-1 "Direct link to heading")
...
### Using the `redirect: false` option[​](https://next-auth.js.org/getting-started/client#using-the-redirect-false-option-1 "Direct link to heading")
...
If you are using the App Router, we encourage you to use [`getServerSession`](https://next-auth.js.org/configuration/nextjs#getserversession) in server contexts instead. (`SessionProvider` _can_ be used in the App Router, which might be the easier choice if you are migrating from pages.)
...
If every one of your pages needs to be protected, you can do this in `getInitialProps` in `_app`, otherwise you can do it on a page-by-page basis. Alternatively, you can do per page authentication checks client side, instead of having each authentication check be blocking (SSR) by using the method described below in [alternative client session handling](https://next-auth.js.org/getting-started/client#custom-client-session-handling).

### Options[​](https://next-auth.js.org/getting-started/client#options "Direct link to heading")
...
#### Base path[​](https://next-auth.js.org/getting-started/client#base-path "Direct link to heading")
...
#### Refetch interval[​](https://next-auth.js.org/getting-started/client#refetch-interval "Direct link to heading")

See [Session Refetching](https://next-auth.js.org/getting-started/client#refetching-the-session) for an alternative option.
...
The value for `refetchInterval` should always be lower than the value of the session `maxAge` [session option](https://next-auth.js.org/configuration/options#session).
...
#### Refetch On Window Focus[​](https://next-auth.js.org/getting-started/client#refetch-on-window-focus "Direct link to heading")
...
See [**the Next.js documentation**](https://nextjs.org/docs/advanced-features/custom-app) for more information on **\_ app.js** in Next.js applications.

### Custom base path[​](https://next-auth.js.org/getting-started/client#custom-base-path "Direct link to heading")

When your Next.js application uses a custom base path, set the `NEXTAUTH_URL` environment variable to the route to the API endpoint in full - as in the example below and as explained [here](https://next-auth.js.org/configuration/options#nextauth_url).
...
#### Example[​](https://next-auth.js.org/getting-started/client#example-3 "Direct link to heading")
