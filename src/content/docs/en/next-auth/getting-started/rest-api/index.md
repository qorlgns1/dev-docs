---
title: "REST API"
description: "NextAuth.js exposes a REST API that is used by the NextAuth.js client."
---
...
This endpoint is also used by the [`signIn`](https://next-auth.js.org/getting-started/client#signin) method internally.
...
This endpoint is also used by the [`signOut`](https://next-auth.js.org/getting-started/client#signout) method internally.
...
The contents of the session object that is returned are configurable with the [`session` callback](https://next-auth.js.org/configuration/callbacks#session-callback).
