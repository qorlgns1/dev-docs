...
description: "To test an implementation of NextAuth.js, we encourage you to use Cypress."
---
...
## Setting up Cypress[​](https://next-auth.js.org/v3/tutorials/testing-with-cypress#setting-up-cypress "Direct link to heading")
...
## Writing a test[​](https://next-auth.js.org/v3/tutorials/testing-with-cypress#writing-a-test "Direct link to heading")
