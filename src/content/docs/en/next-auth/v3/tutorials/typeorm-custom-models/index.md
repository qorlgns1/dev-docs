...
description: "NextAuth.js provides a set of models and schemas for the built-in TypeORM adapter that you can easily extend."
---

Source URL: https://next-auth.js.org/v3/tutorials/typeorm-custom-models

# Custom models with TypeORM | NextAuth.js
...
## Creating custom models[​](https://next-auth.js.org/v3/tutorials/typeorm-custom-models#creating-custom-models "Direct link to heading")
...
## Using custom models[​](https://next-auth.js.org/v3/tutorials/typeorm-custom-models#using-custom-models "Direct link to heading")
