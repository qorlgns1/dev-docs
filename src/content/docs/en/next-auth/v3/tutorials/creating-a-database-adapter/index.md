...
description: "Using a custom adapter you can connect to any database backend or even several different databases. Custom adapters created and maintained by our comm..."
---

Source URL: https://next-auth.js.org/v3/tutorials/creating-a-database-adapter

# Creating a database adapter | NextAuth.js
...
## How to create an adapter[​](https://next-auth.js.org/v3/tutorials/creating-a-database-adapter#how-to-create-an-adapter "Direct link to heading")
...
### Required methods[​](https://next-auth.js.org/v3/tutorials/creating-a-database-adapter#required-methods "Direct link to heading")
...
### Unimplemented methods[​](https://next-auth.js.org/v3/tutorials/creating-a-database-adapter#unimplemented-methods "Direct link to heading")
...
### Example code[​](https://next-auth.js.org/v3/tutorials/creating-a-database-adapter#example-code "Direct link to heading")
