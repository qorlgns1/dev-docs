...
## Sign in callback[​](https://next-auth.js.org/v3/configuration/callbacks#sign-in-callback "Direct link to heading")
...
## Redirect callback[​](https://next-auth.js.org/v3/configuration/callbacks#redirect-callback "Direct link to heading")
...
## JWT callback[​](https://next-auth.js.org/v3/configuration/callbacks#jwt-callback "Direct link to heading")
...
## Session callback[​](https://next-auth.js.org/v3/configuration/callbacks#session-callback "Direct link to heading")
