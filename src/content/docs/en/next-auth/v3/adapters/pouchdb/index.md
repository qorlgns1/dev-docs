---
title: "PouchDB"
description: "This is the PouchDB Adapter for . This package can only be used in conjunction with the primary  package. It is not a standalone package."
---

Source URL: https://next-auth.js.org/v3/adapters/pouchdb
...
## Getting Started[​](https://next-auth.js.org/v3/adapters/pouchdb#getting-started "Direct link to heading")
...
## Advanced[​](https://next-auth.js.org/v3/adapters/pouchdb#advanced "Direct link to heading")

### Memory-First Caching Strategy[​](https://next-auth.js.org/v3/adapters/pouchdb#memory-first-caching-strategy "Direct link to heading")
