---
title: "Models"
description: "Models in NextAuth.js are built for ANSI SQL but are polymorphic and are transformed to adapt to the database being used; there is some variance in sp..."
---
...
You can [extend the built in models](https://next-auth.js.org/v3/tutorials/typeorm-custom-models) and even [create your own database adapter](https://next-auth.js.org/tutorials/creating-a-database-adapter) if you want to use NextAuth.js with a database that is not supported out of the box.
