---
title: "DynamoDB"
description: "This is the AWS DynamoDB Adapter for next-auth. This package can only be used in conjunction with the primary next-auth package. It is not a standalon..."
---
...
## Getting Started[​](https://next-auth.js.org/v3/adapters/dynamodb#getting-started "Direct link to heading")
...
## Schema[​](https://next-auth.js.org/v3/adapters/dynamodb#schema "Direct link to heading")
