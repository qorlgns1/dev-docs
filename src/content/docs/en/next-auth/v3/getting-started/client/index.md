...
#### Example Session Object[​](https://next-auth.js.org/v3/getting-started/client#example-session-object "Direct link to heading")
...
It works best when the [`<Provider>`](https://next-auth.js.org/v3/getting-started/client#provider) is added to `pages/_app.js`.

#### Example[​](https://next-auth.js.org/v3/getting-started/client#example "Direct link to heading")
...
#### Client Side Example[​](https://next-auth.js.org/v3/getting-started/client#client-side-example "Direct link to heading")
...
#### Server Side Example[​](https://next-auth.js.org/v3/getting-started/client#server-side-example "Direct link to heading")
...
#### Client Side Example[​](https://next-auth.js.org/v3/getting-started/client#client-side-example-1 "Direct link to heading")
...
#### Server Side Example[​](https://next-auth.js.org/v3/getting-started/client#server-side-example-1 "Direct link to heading")
...
#### Redirects to sign in page when clicked[​](https://next-auth.js.org/v3/getting-started/client#redirects-to-sign-in-page-when-clicked "Direct link to heading")
...
#### Starts Google OAuth sign-in flow when clicked[​](https://next-auth.js.org/v3/getting-started/client#starts-google-oauth-sign-in-flow-when-clicked "Direct link to heading")
...
#### Starts Email sign-in flow when clicked[​](https://next-auth.js.org/v3/getting-started/client#starts-email-sign-in-flow-when-clicked "Direct link to heading")
...
#### Specifying a callbackUrl[​](https://next-auth.js.org/v3/getting-started/client#specifying-a-callbackurl "Direct link to heading")
...
#### Using the redirect: false option[​](https://next-auth.js.org/v3/getting-started/client#using-the-redirect-false-option "Direct link to heading")
...
#### Additional params[​](https://next-auth.js.org/v3/getting-started/client#additional-params "Direct link to heading")
...
#### Specifying a callbackUrl[​](https://next-auth.js.org/v3/getting-started/client#specifying-a-callbackurl-1 "Direct link to heading")
...
#### Using the redirect: false option[​](https://next-auth.js.org/v3/getting-started/client#using-the-redirect-false-option-1 "Direct link to heading")
...
If every one of your pages needs to be protected, you can do this in `_app`, otherwise you can do it on a page-by-page basis. Alternatively, you can do per page authentication checks client side, instead of having each auth check be blocking (SSR) by using the method described below in [alternative client session handling](https://next-auth.js.org/v3/getting-started/client#custom-client-session-handling).

### Options[​](https://next-auth.js.org/v3/getting-started/client#options "Direct link to heading")
...
#### Client Max Age[​](https://next-auth.js.org/v3/getting-started/client#client-max-age "Direct link to heading")
...
## Alternatives[​](https://next-auth.js.org/v3/getting-started/client#alternatives "Direct link to heading")

### Custom Client Session Handling[​](https://next-auth.js.org/v3/getting-started/client#custom-client-session-handling "Direct link to heading")
