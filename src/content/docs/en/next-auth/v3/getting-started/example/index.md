...
Source URL: https://next-auth.js.org/v3/getting-started/example

# Example Code | NextAuth.js

Version: v3

## Get started with NextAuth.js[​](https://next-auth.js.org/v3/getting-started/example#get-started-with-nextauthjs "Direct link to heading")
...
### Add API route[​](https://next-auth.js.org/v3/getting-started/example#add-api-route "Direct link to heading")

To add NextAuth.js to a project create a file called `[...nextauth].js` in `pages/api/auth`.

[Read more about how to add authentication providers.](https://next-auth.js.org/providers)
...
### Add React Hook[​](https://next-auth.js.org/v3/getting-started/example#add-react-hook "Direct link to heading")
...
### Add session state[​](https://next-auth.js.org/v3/getting-started/example#add-session-state "Direct link to heading")
...
### Deploying to production[​](https://next-auth.js.org/v3/getting-started/example#deploying-to-production "Direct link to heading")
