---
title: "TypeScript"
description: "NextAuth.js comes with its own type definitions, so you can safely use it in your TypeScript projects. Even if you don't use TypeScript, IDEs like VSC..."
---
...
## Adapters[​](https://next-auth.js.org/v3/getting-started/typescript#adapters "Direct link to heading")
...
## Module Augmentation[​](https://next-auth.js.org/v3/getting-started/typescript#module-augmentation "Direct link to heading")
...
### Main module[​](https://next-auth.js.org/v3/getting-started/typescript#main-module "Direct link to heading")
...
#### Popular interfaces to augment[​](https://next-auth.js.org/v3/getting-started/typescript#popular-interfaces-to-augment "Direct link to heading")
...
### Submodules[​](https://next-auth.js.org/v3/getting-started/typescript#submodules "Direct link to heading")
...
### Useful links[​](https://next-auth.js.org/v3/getting-started/typescript#useful-links "Direct link to heading")
...
## Contributing[​](https://next-auth.js.org/v3/getting-started/typescript#contributing "Direct link to heading")
