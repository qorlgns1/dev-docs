...
Source URL: https://next-auth.js.org/v3/providers/wordpress

# WordPress.com | NextAuth.js

Version: v3

## Documentation[​](https://next-auth.js.org/v3/providers/wordpress#documentation "Direct link to heading")

<https://developer.wordpress.com/docs/oauth2/>

## Configuration[​](https://next-auth.js.org/v3/providers/wordpress#configuration "Direct link to heading")

<https://developer.wordpress.com/apps/>

## Options[​](https://next-auth.js.org/v3/providers/wordpress#options "Direct link to heading")
...
## Example[​](https://next-auth.js.org/v3/providers/wordpress#example "Direct link to heading")
