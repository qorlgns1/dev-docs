---
title: "Apple"
description: "The Apple Provider comes with a set of default options:"
---
...
## Documentation[​](https://next-auth.js.org/v3/providers/apple#documentation "Direct link to heading")

<https://developer.apple.com/sign-in-with-apple/get-started/>

## Configuration[​](https://next-auth.js.org/v3/providers/apple#configuration "Direct link to heading")

<https://developer.apple.com/account/resources/identifiers/list/serviceId>

## Options[​](https://next-auth.js.org/v3/providers/apple#options "Direct link to heading")
...
## Example[​](https://next-auth.js.org/v3/providers/apple#example "Direct link to heading")

There are two ways you can use the Sign in with Apple provider.

### Dynamically generated secret[​](https://next-auth.js.org/v3/providers/apple#dynamically-generated-secret "Direct link to heading")
...
### Pre-generated secret[​](https://next-auth.js.org/v3/providers/apple#pre-generated-secret "Direct link to heading")
...
## Instructions[​](https://next-auth.js.org/v3/providers/apple#instructions "Direct link to heading")

### Testing[​](https://next-auth.js.org/v3/providers/apple#testing "Direct link to heading")
...
### Example server[​](https://next-auth.js.org/v3/providers/apple#example-server "Direct link to heading")
...
#### Create certificate[​](https://next-auth.js.org/v3/providers/apple#create-certificate "Direct link to heading")
...
### Example JWT code[​](https://next-auth.js.org/v3/providers/apple#example-jwt-code "Direct link to heading")
