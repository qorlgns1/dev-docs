---
title: "Bungie"
description: "The Bungie Provider comes with a set of default options:"
---

Source URL: https://next-auth.js.org/v3/providers/bungie

# Bungie | NextAuth.js

Version: v3

## Documentation[​](https://next-auth.js.org/v3/providers/bungie#documentation "Direct link to heading")

<https://github.com/Bungie-net/api/wiki/OAuth-Documentation>

## Configuration[​](https://next-auth.js.org/v3/providers/bungie#configuration "Direct link to heading")

<https://www.bungie.net/en/Application>

## Options[​](https://next-auth.js.org/v3/providers/bungie#options "Direct link to heading")
...
## Example[​](https://next-auth.js.org/v3/providers/bungie#example "Direct link to heading")
...
### Configuration[​](https://next-auth.js.org/v3/providers/bungie#configuration-1 "Direct link to heading")
...
### Example server[​](https://next-auth.js.org/v3/providers/bungie#example-server "Direct link to heading")
...
#### Create certificate[​](https://next-auth.js.org/v3/providers/bungie#create-certificate "Direct link to heading")
