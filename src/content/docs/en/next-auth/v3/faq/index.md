...
description: "NextAuth.js is an open source project built by individual contributors."
---
...
## About NextAuth.js[​](https://next-auth.js.org/v3/faq#about-nextauthjs "Direct link to heading")

### Is NextAuth.js commercial software?[​](https://next-auth.js.org/v3/faq#is-nextauthjs-commercial-software "Direct link to heading")
...
## Compatibility[​](https://next-auth.js.org/v3/faq#compatibility "Direct link to heading")

### What databases does NextAuth.js support?[​](https://next-auth.js.org/v3/faq#what-databases-does-nextauthjs-support "Direct link to heading")

You can use NextAuth.js with MySQL, MariaDB, Postgres, MongoDB and SQLite or without a database. (See also: [Databases](https://next-auth.js.org/configuration/databases))
...
### What authentication services does NextAuth.js support?[​](https://next-auth.js.org/v3/faq#what-authentication-services-does-nextauthjs-support "Direct link to heading")

NextAuth.js includes built-in support for signing in with 42 School, Amazon Cognito, Apple, Atlassian, Auth0, Authentik, Azure Active Directory, Azure Active Directory B2C, Battle.net, Box, BoxyHQ SAML, Bungie, Coinbase, Credentials, Discord, Dropbox, DuendeIdentityServer6, EVE Online, Email, FACEIT, Facebook, Foursquare, Freshbooks, FusionAuth, GitHub, GitLab, Google, HubSpot, IdentityServer4, Instagram, Kakao, Keycloak, LINE, LinkedIn, Mail.ru, Mailchimp, Medium, Naver, Netlify, Okta, OneLogin, Osso, Patreon, Pinterest, Pipedrive, Reddit, Salesforce, Slack, Spotify, Strava, Todoist, Trakt, Twitch, Twitter, United Effects, VK, Wikimedia, WordPress.com, WorkOS, Yandex, Zitadel, Zoho, Zoom, osu!. (See also: [Providers](https://next-auth.js.org/configuration/providers/oauth))

NextAuth.js also supports email for passwordless sign in, which is useful for account recovery or for people who are not able to use an account with the configured OAuth services (e.g. due to service outage, account suspension or otherwise becoming locked out of an account).

You can also use a custom based provider to support signing in with a username and password stored in an external database and/or using two factor authentication.

### Does NextAuth.js support signing in with a username and password?[​](https://next-auth.js.org/v3/faq#does-nextauthjs-support-signing-in-with-a-username-and-password "Direct link to heading")
...
### Can I use NextAuth.js with a website that does not use Next.js?[​](https://next-auth.js.org/v3/faq#can-i-use-nextauthjs-with-a-website-that-does-not-use-nextjs "Direct link to heading")
...
If you use NextAuth.js on a website with a different subdomain then the rest of your website (e.g. `auth.example.com` vs `www.example.com`) you will need to set a custom cookie domain policy for the Session Token cookie. (See also: [Cookies](https://next-auth.js.org/configuration/options#cookies))
...
### Can I use NextAuth.js with React Native?[​](https://next-auth.js.org/v3/faq#can-i-use-nextauthjs-with-react-native "Direct link to heading")
...
### Is NextAuth.js supporting TypeScript?[​](https://next-auth.js.org/v3/faq#is-nextauthjs-supporting-typescript "Direct link to heading")

Yes! Check out the [TypeScript docs](https://next-auth.js.org/getting-started/typescript)

---

## Databases[​](https://next-auth.js.org/v3/faq#databases "Direct link to heading")

### What databases are supported by NextAuth.js?[​](https://next-auth.js.org/v3/faq#what-databases-are-supported-by-nextauthjs "Direct link to heading")
...
### What does NextAuth.js use databases for?[​](https://next-auth.js.org/v3/faq#what-does-nextauthjs-use-databases-for "Direct link to heading")
...
### Should I use a database?[​](https://next-auth.js.org/v3/faq#should-i-use-a-database "Direct link to heading")
...
### What database should I use?[​](https://next-auth.js.org/v3/faq#what-database-should-i-use "Direct link to heading")
...
## Security[​](https://next-auth.js.org/v3/faq#security "Direct link to heading")

### I think I've found a security problem, what should I do?[​](https://next-auth.js.org/v3/faq#i-think-ive-found-a-security-problem-what-should-i-do "Direct link to heading")
...
If you discover what you think may be a potentially serious security problem, please contact a core team member via a private channel (e.g. via email to [me@iaincollins.com](mailto:me@iaincollins.com)) or raise a public issue requesting someone get in touch with you via whatever means you prefer for more details.

### What is the disclosure policy for NextAuth.js?[​](https://next-auth.js.org/v3/faq#what-is-the-disclosure-policy-for-nextauthjs "Direct link to heading")
...
### How do I get Refresh Tokens and Access Tokens for an OAuth account?[​](https://next-auth.js.org/v3/faq#how-do-i-get-refresh-tokens-and-access-tokens-for-an-oauth-account "Direct link to heading")
...
### When I sign in with another account with the same email address, why are accounts not linked automatically?[​](https://next-auth.js.org/v3/faq#when-i-sign-in-with-another-account-with-the-same-email-address-why-are-accounts-not-linked-automatically "Direct link to heading")
...
## Feature Requests[​](https://next-auth.js.org/v3/faq#feature-requests "Direct link to heading")

### Why doesn't NextAuth.js support [a particular feature]?[​](https://next-auth.js.org/v3/faq#why-doesnt-nextauthjs-support-a-particular-feature "Direct link to heading")
...
### I disagree with a design decision, how can I change your mind?[​](https://next-auth.js.org/v3/faq#i-disagree-with-a-design-decision-how-can-i-change-your-mind "Direct link to heading")
...
### Does NextAuth.js use JSON Web Tokens?[​](https://next-auth.js.org/v3/faq#does-nextauthjs-use-json-web-tokens "Direct link to heading")
...
### What are the advantages of JSON Web Tokens?[​](https://next-auth.js.org/v3/faq#what-are-the-advantages-of-json-web-tokens "Direct link to heading")
...
### What are the disadvantages of JSON Web Tokens?[​](https://next-auth.js.org/v3/faq#what-are-the-disadvantages-of-json-web-tokens "Direct link to heading")
...
### Are JSON Web Tokens secure?[​](https://next-auth.js.org/v3/faq#are-json-web-tokens-secure "Direct link to heading")
...
### What signing and encryption standards does NextAuth.js support?[​](https://next-auth.js.org/v3/faq#what-signing-and-encryption-standards-does-nextauthjs-support "Direct link to heading")
