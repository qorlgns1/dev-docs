...
Source URL: https://next-auth.js.org/faq
...
A working example can be found at [this example repo](https://github.com/vercel/examples/tree/main/solutions/subdomain-auth).
...
[Next.js Middleware](https://nextjs.org/docs/middleware) is supported. Head over to the [this page](https://next-auth.js.org/configuration/nextjs#middleware)
