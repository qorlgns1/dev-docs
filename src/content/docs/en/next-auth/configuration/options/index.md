---
title: "Options"
description: "When deploying to production, set the  environment variable to the canonical URL of your site."
---
...
## Environment Variables[​](https://next-auth.js.org/configuration/options#environment-variables "Direct link to heading")
...
If your Next.js application uses a custom base path, specify the route to the API endpoint in full. More information about the usage of custom base path [here](https://next-auth.js.org/getting-started/client#custom-base-path).

_e.g.`NEXTAUTH_URL=https://example.com/custom-route/api/auth`_

tip

When you're using a custom base path, you will need to pass the `basePath` page prop to the `<SessionProvider>`. More information [here](https://next-auth.js.org/getting-started/client#custom-base-path).
...
Used to encrypt the NextAuth.js JWT, and to hash [email verification tokens](https://authjs.dev/guides/creating-a-database-adapter#verification-tokens). This is the default value for the `secret` option in [NextAuth](https://next-auth.js.org/configuration/options#secret) and [Middleware](https://next-auth.js.org/configuration/nextjs#secret). Alternatively, you can also set `AUTH_SECRET`, which is an alias, and is the preferred naming going forward.
...
## Options[​](https://next-auth.js.org/configuration/options#options "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description "Direct link to heading")

An array of authentication providers for signing in (e.g. Google, Facebook, Twitter, GitHub, Email, etc) in any order. This can be one of the built-in providers or an object with a custom provider.

See the [providers documentation](https://next-auth.js.org/configuration/providers/oauth) for a list of supported providers and how to use them.
...
#### Description[​](https://next-auth.js.org/configuration/options#description-1 "Direct link to heading")

A random string is used to hash tokens, sign/encrypt cookies and generate cryptographic keys.

If you set [`NEXTAUTH_SECRET`](https://next-auth.js.org/configuration/options#nextauth_secret) as an environment variable, you don't have to define this option.
...
Not providing any `secret` or `NEXTAUTH_SECRET` will throw [an error](https://next-auth.js.org/errors#no_secret) in production.
...
#### Description[​](https://next-auth.js.org/configuration/options#description-2 "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-3 "Direct link to heading")
...
#### JSON Web Token Options[​](https://next-auth.js.org/configuration/options#json-web-token-options "Direct link to heading")
...
When using a custom session token `cookieName`, the same name should also be provided to `getToken`. If you are using the Next.js [`withAuth`](https://next-auth.js.org/configuration/nextjs#middleware) middleware, you will also need to configure this using the same `cookieName`.
...
#### Description[​](https://next-auth.js.org/configuration/options#description-4 "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-5 "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-6 "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-7 "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-8 "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-9 "Direct link to heading")
...
The `code` parameter for `error` and `warn` are explained in the [Warnings](https://next-auth.js.org/warnings) and [Errors](https://next-auth.js.org/errors) pages respectively.
...
If the `debug` level is defined by the user, it will be called regardless of the `debug: false` [option](https://next-auth.js.org/configuration/options#debug).
...
## Advanced Options[​](https://next-auth.js.org/configuration/options#advanced-options "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-11 "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/options#description-12 "Direct link to heading")
...
#### Example[​](https://next-auth.js.org/configuration/options#example "Direct link to heading")
...
### Override JWT `encode` and `decode` methods[​](https://next-auth.js.org/configuration/options#override-jwt-encode-and-decode-methods "Direct link to heading")
...
**IMPORTANT: If you use middleware to protect routes, make sure the same method is also set in the[`_middleware.ts` options](https://next-auth.js.org/configuration/nextjs#custom-jwt-decode-method)**
