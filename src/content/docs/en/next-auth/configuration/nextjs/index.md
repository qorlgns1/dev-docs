---
title: "Next.js"
description: "You can create a helper function so you don't need to pass  around:"
---
...
### In `getServerSideProps`:[​](https://next-auth.js.org/configuration/nextjs#in-getserversideprops "Direct link to heading")
...
### In API Routes:[​](https://next-auth.js.org/configuration/nextjs#in-api-routes "Direct link to heading")
...
### In App Router:[​](https://next-auth.js.org/configuration/nextjs#in-app-router "Direct link to heading")
...
### Caching[​](https://next-auth.js.org/configuration/nextjs#caching "Direct link to heading")
...
If the following options look familiar, this is because they are a subset of [these options](https://next-auth.js.org/configuration/options#options). You can extract these to a common configuration object to reuse them. In the future, we would like to be able to run everything in Middleware. (See [Caveats](https://next-auth.js.org/configuration/nextjs#caveats)).

You can get the `withAuth` middleware function from `next-auth/middleware` either as a default or a named import:

### Prerequisites[​](https://next-auth.js.org/configuration/nextjs#prerequisites "Direct link to heading")

You must set the same secret in the middleware that you use in NextAuth. The easiest way is to set the [`NEXTAUTH_SECRET`](https://next-auth.js.org/configuration/options#nextauth_secret) environment variable. It will be picked up by both the [NextAuth config](https://next-auth.js.org/configuration/options#options), as well as the middleware config.

Alternatively, you can provide the secret using the [`secret`](https://next-auth.js.org/configuration/nextjs#secret) option in the middleware config.

**We strongly recommend** replacing the `secret` value completely with this `NEXTAUTH_SECRET` environment variable.

### Basic usage[​](https://next-auth.js.org/configuration/nextjs#basic-usage "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/nextjs#description "Direct link to heading")

Callbacks are asynchronous functions you can use to control what happens when an action is performed.

#### Example (default value)[​](https://next-auth.js.org/configuration/nextjs#example-default-value "Direct link to heading")
...
#### Description[​](https://next-auth.js.org/configuration/nextjs#description-1 "Direct link to heading")
...
#### Example (default value)[​](https://next-auth.js.org/configuration/nextjs#example-default-value-1 "Direct link to heading")
...
For more information, see the documentation for the [pages option](https://next-auth.js.org/configuration/pages).
...
#### Description[​](https://next-auth.js.org/configuration/nextjs#description-2 "Direct link to heading")

The same `secret` is used in the [NextAuth.js config](https://next-auth.js.org/configuration/options#options).

#### Example (default value)[​](https://next-auth.js.org/configuration/nextjs#example-default-value-2 "Direct link to heading")
...
### Advanced usage[​](https://next-auth.js.org/configuration/nextjs#advanced-usage "Direct link to heading")
...
#### wrap middleware[​](https://next-auth.js.org/configuration/nextjs#wrap-middleware "Direct link to heading")
...
#### Custom JWT decode method[​](https://next-auth.js.org/configuration/nextjs#custom-jwt-decode-method "Direct link to heading")
...
### Caveats[​](https://next-auth.js.org/configuration/nextjs#caveats "Direct link to heading")
...
- Only supports the `"jwt"` [session strategy](https://next-auth.js.org/configuration/options#session). We need to wait until databases at the Edge become mature enough to ensure a fast experience. (If you know of an Edge-compatible database, we would like if you proposed a new [Adapter](https://authjs.dev/guides/creating-a-database-adapter))
