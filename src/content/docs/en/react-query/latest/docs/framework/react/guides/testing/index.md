---
title: 'Testing'
description: 'React Query works by means of hooks - either the ones we offer or custom ones that wrap around them.'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/testing
