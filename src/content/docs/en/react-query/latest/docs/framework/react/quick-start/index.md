---
title: 'Quick Start'
description: 'This code snippet very briefly illustrates the 3 core concepts of React Query:'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/quick-start
