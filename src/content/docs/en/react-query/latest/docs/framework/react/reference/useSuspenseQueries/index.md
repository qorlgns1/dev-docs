...
The same as for [useQueries](https://tanstack.com/query/latest/docs/framework/react/reference/useQueries.md), except that each `query` can't have:
...
Same structure as [useQueries](https://tanstack.com/query/latest/docs/framework/react/reference/useQueries.md), except that for each `query`:
