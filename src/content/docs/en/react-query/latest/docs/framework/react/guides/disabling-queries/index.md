...
description: 'If you ever want to disable a query from automatically running, you can use the  option. The enabled option also accepts a callback that returns a boo...'
---
