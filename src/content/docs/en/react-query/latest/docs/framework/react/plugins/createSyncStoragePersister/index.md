...
description: 'This plugin is deprecated and will be removed in the next major version.'
---
...
You can simply use ['@tanstack/query-async-storage-persister'](https://tanstack.com/query/latest/docs/framework/react/plugins/createAsyncStoragePersister.md) instead.
...
- Pass it to the [`persistQueryClient`](https://tanstack.com/query/latest/docs/framework/react/plugins/persistQueryClient.md) function
