---
title: 'hydration'
description: 'creates a frozen representation of a  that can later be hydrated with  or . This is useful for passing prefetched queries from server to client or per...'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/reference/hydration
