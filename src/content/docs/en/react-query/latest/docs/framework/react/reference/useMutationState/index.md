...
description: 'is a hook that gives you access to all mutations in the . You can pass  to it to narrow down your mutations, and  to transform the mutation state.'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/reference/useMutationState
