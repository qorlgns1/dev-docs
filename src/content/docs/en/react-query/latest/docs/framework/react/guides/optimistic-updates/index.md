...
description: 'React Query provides two ways to optimistically update your UI before a mutation has completed. You can either use the  option to update your cache di...'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/optimistic-updates
