---
title: 'Installation'
description: 'You can install React Query via NPM,'
---
...
It is recommended to also use our [ESLint Plugin Query](https://tanstack.com/query/latest/docs/eslint/eslint-plugin-query.md) to help you catch bugs and inconsistencies while you code. You can install it via:
