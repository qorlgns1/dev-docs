...
description: 'Welcome to the Advanced Server Rendering guide, where you will learn all about using React Query with streaming, Server Components and the Next.js app...'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/advanced-ssr
...
You might want to read the [Server Rendering & Hydration guide](https://tanstack.com/query/latest/docs/framework/react/guides/ssr.md) before this one as it teaches the basics for using React Query with SSR, and [Performance & Request Waterfalls](https://tanstack.com/query/latest/docs/framework/react/guides/request-waterfalls.md) as well as [Prefetching & Router Integration](https://tanstack.com/query/latest/docs/framework/react/guides/prefetching.md) also contains valuable background.
