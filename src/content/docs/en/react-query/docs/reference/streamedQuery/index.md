---
title: 'streamedQuery'
description: 'is a helper function to create a query function that streams data from an AsyncIterable. Data will be an Array of all the chunks received. The query w...'
---

Source URL: https://tanstack.com/query/latest/docs/reference/streamedQuery
