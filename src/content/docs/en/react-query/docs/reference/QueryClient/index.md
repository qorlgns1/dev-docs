---
title: 'QueryClient'
description: 'The  can be used to interact with a cache:'
---
...
- `defaultOptions?: DefaultOptions`
  ...
  - You can also define defaults to be used for [hydration](https://tanstack.com/query/latest/docs/framework/react/reference/hydration.md)
...
TanStack Query also exports a handy [`useIsFetching`](https://tanstack.com/query/latest/docs/framework/react/reference/useIsFetching.md) hook that will let you subscribe to this state in your components without creating a manual subscription to the query cache.
...
TanStack Query also exports a handy [`useIsMutating`](https://tanstack.com/query/latest/docs/framework/react/reference/useIsMutating.md) hook that will let you subscribe to this state in your components without creating a manual subscription to the mutation cache.
