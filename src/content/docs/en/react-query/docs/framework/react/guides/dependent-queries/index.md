...
description: "Dependent (or serial) queries depend on previous ones to finish before they can execute. To achieve this, it's as easy as using the  option to tell a ..."
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/dependent-queries
