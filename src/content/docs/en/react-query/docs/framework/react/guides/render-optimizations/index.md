...
description: 'React Query applies a couple of optimizations automatically to ensure that your components only re-render when they actually need to. This is done by ...'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/render-optimizations
