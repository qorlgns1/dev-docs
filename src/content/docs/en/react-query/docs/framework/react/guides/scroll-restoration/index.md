...
description: 'Traditionally, when you navigate to a previously visited page on a web browser, you would find that the page would be scrolled to the exact position w...'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/scroll-restoration
