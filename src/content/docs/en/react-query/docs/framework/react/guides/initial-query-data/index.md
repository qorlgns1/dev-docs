...
description: 'There are many ways to supply initial data for a query to the cache before you need it:'
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/initial-query-data
...
- Imperatively:
  - [Prefetch the data using `queryClient.prefetchQuery`](https://tanstack.com/query/latest/docs/framework/react/guides/prefetching.md)
  - [Manually place the data into the cache using `queryClient.setQueryData`](https://tanstack.com/query/latest/docs/framework/react/guides/prefetching.md)
