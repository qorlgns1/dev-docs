---
title: 'Suspense'
description: "React Query can also be used with React's Suspense for Data Fetching APIs. For this, we have dedicated hooks:"
---

Source URL: https://tanstack.com/query/latest/docs/framework/react/guides/suspense
...
For more information, check out the [NextJs Suspense Streaming Example](https://tanstack.com/query/latest/docs/framework/react/examples/nextjs-suspense-streaming) and the [Advanced Rendering & Hydration](https://tanstack.com/query/latest/docs/framework/react/guides/advanced-ssr.md) guide.
