---
title: 'Migrate from 6.x to 7.x | Sentry for Next.js'
description: 'The v7 version of the JavaScript SDK requires a self-hosted version of Sentry  or higher.'
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v6-to-v7

# Migrate from 6.x to 7.x | Sentry for Next.js
