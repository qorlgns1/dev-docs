---
title: 'Example Instrumentation | Sentry for Next.js'
description: 'The sample code on this page is for demonstration purposes only. It isn’t production-ready and may not apply directly to your language or framework.'
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/span-metrics/examples

# Example Instrumentation | Sentry for Next.js
...
## [E-Commerce Checkout Flow (React + Backend)](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/span-metrics/examples.md#e-commerce-checkout-flow-react--backend)
...
## [Media Upload with Background Processing (React + Express)](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/span-metrics/examples.md#media-upload-with-background-processing-react--express)
...
This example demonstrates proper queue instrumentation patterns. For more details on instrumenting queues, see the [Queues Module documentation](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/instrumentation/queues-module.md).
...
## [Search Autocomplete (debounced, cancellable, performance monitoring)](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/span-metrics/examples.md#search-autocomplete-debounced-cancellable-performance-monitoring)
...
## [Manual LLM Instrumentation (Custom AI Agent + Tool Calls)](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/span-metrics/examples.md#manual-llm-instrumentation-custom-ai-agent--tool-calls)
