---
title: 'Transports | Sentry for Next.js'
description: "The JavaScript SDK uses a  to send events to Sentry. On modern browsers, most transports use the browsers'  API to send events. Transports will drop a..."
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/configuration/transports

# Transports | Sentry for Next.js
