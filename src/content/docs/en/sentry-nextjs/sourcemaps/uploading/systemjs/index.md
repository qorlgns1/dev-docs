---
title: 'SystemJS | Sentry for Next.js'
...
- [1. Generate Source Maps](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#1-generate-source-maps)
...
- [2. Configure Sentry CLI](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#2-configure-sentry-cli)
...
- [3. Inject Debug IDs Into Artifacts](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#3-inject-debug-ids-into-artifacts)
...
#
- [Verify Debug IDs Were Injected in Artifacts](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#verify-debug-ids-were-injected-in-artifacts)
...
- [4. Upload Artifact Bundle](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#4-upload-artifact-bundle)
...
#
- [Verify That Artifact Bundles Were Uploaded](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#verify-that-artifact-bundles-were-uploaded)
...
- [5. Deploy your Application](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#5-deploy-your-application)
...
- [Optional Steps](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#optional-steps)
...
#
- [Associating `release` with Artifact Bundle](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#associating-release-with-artifact-bundle)
...
#
- [Associating `dist` with Artifact Bundle](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/systemjs.md#associating-dist-with-artifact-bundle)
