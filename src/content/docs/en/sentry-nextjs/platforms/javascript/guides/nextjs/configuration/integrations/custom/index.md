---
title: 'Custom Integrations | Sentry for Next.js'
description: 'In addition to the integrations that come with the SDK, you can also write custom integrations.'
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/configuration/integrations/custom

# Custom Integrations | Sentry for Next.js
...
The `setup` hook is called when the SDK is initialized. It receives the client instance as an argument. You should use this if you want to run some code on initialization.
