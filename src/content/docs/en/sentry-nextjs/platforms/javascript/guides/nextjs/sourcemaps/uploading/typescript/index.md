---
title: 'TypeScript (tsc) | Sentry for Next.js'
description: "In this guide, you'll learn how to successfully upload source maps for TypeScript using our  tool."
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript

# TypeScript (tsc) | Sentry for Next.js
...
## [Automatic Setup](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#automatic-setup)
...
## [Manual Setup](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#manual-setup)

- [1. Generate Source Maps](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#1-generate-source-maps)
...
- [2. Configure Sentry CLI](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#2-configure-sentry-cli)
...
- [3. Inject Debug IDs Into Artifacts](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#3-inject-debug-ids-into-artifacts)
...
#
- [Verify Debug IDs Were Injected in Artifacts](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#verify-debug-ids-were-injected-in-artifacts)
...
- [4. Upload Artifact Bundle](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#4-upload-artifact-bundle)
...
#
- [Verify That Artifact Bundles Were Uploaded](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#verify-that-artifact-bundles-were-uploaded)
...
- [5. Deploy your Application](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#5-deploy-your-application)
...
- [Optional Steps](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#optional-steps)
...
#
- [Associating `release` with Artifact Bundle](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#associating-release-with-artifact-bundle)
...
#
- [Associating `dist` with Artifact Bundle](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#associating-dist-with-artifact-bundle)
...
## [Dealing with TSLib](https://docs.sentry.io/platforms/javascript/guides/nextjs/sourcemaps/uploading/typescript.md#dealing-with-tslib)
