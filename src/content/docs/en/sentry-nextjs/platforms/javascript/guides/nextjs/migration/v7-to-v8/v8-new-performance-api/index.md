---
title: 'New Tracing APIs | Sentry for Next.js'
description: 'The SDK  release introduces new APIs for performance monitoring. These APIs are designed to provide more control over how performance data is collecte...'
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api

# New Tracing APIs | Sentry for Next.js
...
- [Creating a child span of a specific span](https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api.md#creating-a-child-span-of-a-specific-span)
...
- [Creating a transaction](https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api.md#creating-a-transaction)
...
## [The Span schema](https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api.md#the-span-schema)
...
## [Other Notable Changes](https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api.md#other-notable-changes)

In addition to generally changing the performance APIs, there are also some smaller changes that this brings with it.

- [Changed `SamplingContext` for `tracesSampler()`](https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api.md#changed-samplingcontext-for-tracessampler)
...
- [No more `undefined` spans](https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api.md#no-more-undefined-spans)
...
- [Forcing a sampling decision](https://docs.sentry.io/platforms/javascript/guides/nextjs/migration/v7-to-v8/v8-new-performance-api.md#forcing-a-sampling-decision)

Previously in v7, you could force a positive or negative sampling decision when calling `startTransaction` by setting the `sampled` option. This would effectively override your [sampling configuration](https://docs.sentry.io/platforms/javascript/guides/nextjs/configuration/sampling.md) for the specific transaction. In v8, the `sampled` option was removed to align with OpenTelemetry. You can still force a decision by defining a `tracesSampler` callback in `Sentry.init` and returning `1` or `0` for specific spans:
