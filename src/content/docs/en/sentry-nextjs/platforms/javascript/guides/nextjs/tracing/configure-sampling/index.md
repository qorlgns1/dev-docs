---
title: 'Configure Sampling | Sentry for Next.js'
description: "Sentry's tracing functionality helps you monitor application performance by capturing distributed traces, attaching attributes, and span performance a..."
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling

# Configure Sampling | Sentry for Next.js
...
1. [Uniform Sample Rate](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#uniform-sample-rate-tracessamplerate) (recommended)
2. [Sampling Function](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#sampling-function-tracessampler)

## [Uniform Sample Rate (`tracesSampleRate`)](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#uniform-sample-rate-tracessamplerate)
...
## [Sampling Function (`tracesSampler`)](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#sampling-function-tracessampler)
...
- [The Sampling Context Object](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#the-sampling-context-object)
...
- [Traces Sampler Examples](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#traces-sampler-examples)
...
## [Sampling Decision Precedence](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#sampling-decision-precedence)
...
## [Conclusion](https://docs.sentry.io/platforms/javascript/guides/nextjs/tracing/configure-sampling.md#conclusion)
