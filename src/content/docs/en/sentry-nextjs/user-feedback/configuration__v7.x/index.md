...
description: 'In version 7 of our JavaScript SDK, User Feedback was released as a Beta integration. We recommend following the migration guide and updating your SDK...'
---
...
The User Feedback Widget offers many customization options, and if the available options are insufficient, you can [use your own UI](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#bring-your-own-widget). The following image shows which elements are customizable. The configuration keys on the left of the image correspond to [text customization](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#text-customization), while the ones on the right side are for [theme customizations](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#theme-customization).

- [General](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#general)
...
- [User and Form](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#user-and-form)
...
By default, the Feedback integration will attempt to fill in the name and email fields if you've set a user context via [`Sentry.setUser()`](https://docs.sentry.io/platforms/javascript/guides/nextjs/enriching-events/identify-user.md). The email and name fields are expected to be `email` and `username`. Below is an example configuration with non-default user fields:
...
- [Text Customization](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#text-customization)
...
- [Theme Customization](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#theme-customization)
...
- [Additional UI Customization](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#additional-ui-customization)
...
- [Event Callbacks](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#event-callbacks)
...
- [Bring Your Own Button](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#bring-your-own-button)
...
- [Bring Your Own Widget](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#bring-your-own-widget)
...
## [Crash-Report Modal](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration__v7.x/#crash-report-modal)
