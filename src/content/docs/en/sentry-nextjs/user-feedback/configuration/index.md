...
description: 'The User Feedback Widget offers many customization options, and if the available options are insufficient, you can use your own UI.'
---

Source URL: https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration

# Configuration | Sentry for Next.js

## [User Feedback Widget](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#user-feedback-widget)

The User Feedback Widget offers many customization options, and if the available options are insufficient, you can [use your own UI](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#bring-your-own-widget).
...
- [General](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#general)
...
| `id`           | `string`                                                                               | `sentry-feedback` | The `id` attribute of the `<div>` that contains the feedback widget. See [CSS Customization](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#css-customization) for more.                         |
| `tags`         | `Record<string, number \| string \| boolean \| bigint \| symbol \| null \| undefined>` | `{}`              | [Tags](https://docs.sentry.io/platforms/javascript/guides/nextjs/enriching-events/tags.md) to set on the feedback event.                                                                                                                   |

- [Auto-Inject vs. Manual Injection](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#auto-inject-vs-manual-injection)
...
Read more about how to [use your own UI](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#bring-your-own-button) below.

- [User and Form](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#user-and-form)
...
- [Text Customization](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#text-customization)
...
- [CSS Customization](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#css-customization)
...
#
- [Theme priority](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#theme-priority)
...
#
- [Custom ID selector](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#custom-id-selector)
...
- [Event Callbacks](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#event-callbacks)
...
- [Bring Your Own Button](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#bring-your-own-button)
...
- [Bring Your Own Widget](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#bring-your-own-widget)
...
- [Loading Strategies](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#loading-strategies)
...
#
- [When Installed Via CDN](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#when-installed-via-cdn)
...
#
- [When Installed Via NPM](https://docs.sentry.io/platforms/javascript/guides/nextjs/user-feedback/configuration.md#when-installed-via-npm)
