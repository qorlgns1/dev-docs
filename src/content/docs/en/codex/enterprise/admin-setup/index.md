...
Codex supports role-based access (see [Role-based access (RBAC)](https://developers.openai.com/codex/enterprise/admin-setup#role-based-access-rbac)), so you can turn on this toggle for a specific subset of users.
