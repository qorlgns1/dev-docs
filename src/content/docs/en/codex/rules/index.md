...
Source URL: https://developers.openai.com/codex/rules
...
Admins can also enforce restrictive `prefix_rule` entries from [`requirements.toml`](https://developers.openai.com/codex/security#admin-enforced-requirements-requirementstoml).
