...
description: "Use columns-<number> utilities like columns-3 to set the number of columns that should be created for the content within an element:"
---

Source URL: https://tailwindcss.com/docs/columns
