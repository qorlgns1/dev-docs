...
description: "Use row-span-<number> utilities like row-span-2 and row-span-4 to make an element span _n_ rows:"
---

Source URL: https://tailwindcss.com/docs/grid-row
