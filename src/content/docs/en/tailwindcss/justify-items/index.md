...
description: "Use the justify-items-start utility to justify grid items against the start of their inline axis:"
---

Source URL: https://tailwindcss.com/docs/justify-items
