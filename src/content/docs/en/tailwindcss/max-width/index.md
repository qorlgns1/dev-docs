...
description: "Use max-w-<number> utilities like max-w-24 and max-w-64 to set an element to a fixed maximum width based on the spacing scale:"
---

Source URL: https://tailwindcss.com/docs/max-width
