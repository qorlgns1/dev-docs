...
description: "Every utility class in Tailwind can be applied _conditionally_ by adding a variant to the beginning of the class name that describes the condition you..."
---

Source URL: https://tailwindcss.com/docs/hover-focus-and-other-states
