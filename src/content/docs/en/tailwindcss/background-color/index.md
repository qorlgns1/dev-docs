...
description: "Use utilities like bg-white, bg-indigo-500 and bg-transparent to control the background color of an element:"
---

Source URL: https://tailwindcss.com/docs/background-color
