...
description: "Use utilities like bg-blend-difference and bg-blend-saturation to control how the background image and color of an element are blended:"
---

Source URL: https://tailwindcss.com/docs/background-blend-mode
