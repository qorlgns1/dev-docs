...
description: "Use max-block-<number> utilities like max-block-24 and max-block-64 to set an element to a fixed maximum block size based on the spacing scale:"
---

Source URL: https://tailwindcss.com/docs/max-block-size
