...
description: "Start by creating a new Ember.js project if you don't have one set up already. The most common approach is to use Ember CLI."
---

Source URL: https://tailwindcss.com/docs/installation/framework-guides/emberjs
