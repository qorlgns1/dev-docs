...
description: "Use utilities like text-shadow-sm and shadow-lg to apply different sized text shadows to a text element:"
---

Source URL: https://tailwindcss.com/docs/text-shadow
