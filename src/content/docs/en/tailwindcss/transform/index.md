...
description: "If your transition performs better when rendered by the GPU instead of the CPU, you can force hardware acceleration by adding the transform-gpu utilit..."
---

Source URL: https://tailwindcss.com/docs/transform
