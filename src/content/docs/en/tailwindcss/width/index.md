...
description: "Use w-<number> utilities like w-24 and w-64 to set an element to a fixed width based on the spacing scale:"
---

Source URL: https://tailwindcss.com/docs/width
