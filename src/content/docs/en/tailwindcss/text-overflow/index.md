...
description: "Use the truncate utility to prevent text from wrapping and truncate overflowing text with an ellipsis (…) if needed:"
---

Source URL: https://tailwindcss.com/docs/text-overflow
