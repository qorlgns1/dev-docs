...
description: "Use h-<number> utilities like h-24 and h-64 to set an element to a fixed height based on the spacing scale:"
---

Source URL: https://tailwindcss.com/docs/height
