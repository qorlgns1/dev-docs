...
description: "Use utilities like grid-flow-col and grid-flow-row-dense to control how the auto-placement algorithm works for a grid layout:"
---

Source URL: https://tailwindcss.com/docs/grid-auto-flow
