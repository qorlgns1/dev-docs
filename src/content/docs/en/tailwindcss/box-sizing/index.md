...
description: "Use the box-border utility to set an element's box-sizing to border-box, telling the browser to include the element's borders and padding when you giv..."
---

Source URL: https://tailwindcss.com/docs/box-sizing
