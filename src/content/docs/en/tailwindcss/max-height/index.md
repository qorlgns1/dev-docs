...
description: "Use max-h-<number> utilities like max-h-24 and max-h-64 to set an element to a fixed maximum height based on the spacing scale:"
---

Source URL: https://tailwindcss.com/docs/max-height
