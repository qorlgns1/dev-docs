...
description: "Use basis-<number> utilities like basis-64 and basis-128 to set the initial size of flex items based on the spacing scale:"
---

Source URL: https://tailwindcss.com/docs/flex-basis
