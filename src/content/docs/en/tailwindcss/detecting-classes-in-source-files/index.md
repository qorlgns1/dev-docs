...
description: "Tailwind works by scanning your project for utility classes, then generating all of the necessary CSS based on the classes you've actually used."
---

Source URL: https://tailwindcss.com/docs/detecting-classes-in-source-files
