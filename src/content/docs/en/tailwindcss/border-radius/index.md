...
description: "Use utilities like rounded-sm and rounded-md to apply different border radius sizes to an element:"
---

Source URL: https://tailwindcss.com/docs/border-radius
