...
description: "Use outline or outline-<number> utilities like outline-2 and outline-4 to set the width of an element's outline:"
---

Source URL: https://tailwindcss.com/docs/outline-width
