...
description: "Tailwind CSS uses custom CSS syntax like @theme, @variant, and @source, and in some editors this can trigger warnings or errors where these rules aren..."
---

Source URL: https://tailwindcss.com/docs/editor-setup
