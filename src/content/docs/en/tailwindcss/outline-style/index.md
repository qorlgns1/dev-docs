...
description: "Use utilities like outline-solid and outline-dashed to set the style of an element's outline:"
---

Source URL: https://tailwindcss.com/docs/outline-style
