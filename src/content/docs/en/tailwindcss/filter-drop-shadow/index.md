...
description: "Use utilities like drop-shadow-sm and drop-shadow-xl to add a drop shadow to an element:"
---

Source URL: https://tailwindcss.com/docs/filter-drop-shadow
