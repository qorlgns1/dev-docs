...
description: "Use the justify-start utility to justify items against the start of the container's main axis:"
---

Source URL: https://tailwindcss.com/docs/justify-content
