...
description: "Use font size utilities like text-sm/6 and text-lg/7 to set the font size and line-height of an element at the same time:"
---

Source URL: https://tailwindcss.com/docs/line-height
