...
description: "Use border or border-<number> utilities like border-2 and border-4 to set the border width for all sides of an element:"
---

Source URL: https://tailwindcss.com/docs/border-width
