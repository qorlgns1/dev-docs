---
title: "Docker"
description: "This Docker image is published to Microsoft Artifact Registry."
---

Source URL: https://playwright.dev/docs/docker

# Docker | Playwright

## Introduction[​](https://playwright.dev/docs/docker#introduction "Direct link to Introduction")

[Dockerfile.noble](https://github.com/microsoft/playwright/blob/main/utils/docker/Dockerfile.noble "Dockerfile.noble") can be used to run Playwright scripts in Docker environment. This image includes the [Playwright browsers](https://playwright.dev/docs/browsers#install-browsers) and [browser system dependencies](https://playwright.dev/docs/browsers#install-system-dependencies). The Playwright package/dependency is not included in the image and should be installed separately.

## Usage[​](https://playwright.dev/docs/docker#usage "Direct link to Usage")
...
### Pull the image[​](https://playwright.dev/docs/docker#pull-the-image "Direct link to Pull the image")
...
### Run the image[​](https://playwright.dev/docs/docker#run-the-image "Direct link to Run the image")

By default, the Docker image will use the `root` user to run the browsers. This will disable the Chromium sandbox which is not available with root. If you run trusted code (e.g. End-to-end tests) and want to avoid the hassle of managing separate user then the root user may be fine. For web scraping or crawling, we recommend to create a separate user inside the Docker container and use the seccomp profile.

#### End-to-end tests[​](https://playwright.dev/docs/docker#end-to-end-tests "Direct link to End-to-end tests")
...
#### Crawling and scraping[​](https://playwright.dev/docs/docker#crawling-and-scraping "Direct link to Crawling and scraping")
...
### Recommended Docker Configuration[​](https://playwright.dev/docs/docker#recommended-docker-configuration "Direct link to Recommended Docker Configuration")
...
### Using on CI[​](https://playwright.dev/docs/docker#using-on-ci "Direct link to Using on CI")

See our [Continuous Integration guides](https://playwright.dev/docs/ci) for sample configs.

### Remote Connection[​](https://playwright.dev/docs/docker#remote-connection "Direct link to Remote Connection")
...
#### Running the Playwright Server[​](https://playwright.dev/docs/docker#running-the-playwright-server "Direct link to Running the Playwright Server")
...
#### Connecting to the Server[​](https://playwright.dev/docs/docker#connecting-to-the-server "Direct link to Connecting to the Server")
...
2. Using the [browserType.connect()](https://playwright.dev/docs/api/class-browsertype#browser-type-connect) API for other applications:
...
#### Network Configuration[​](https://playwright.dev/docs/docker#network-configuration "Direct link to Network Configuration")
...
### Connecting using noVNC and GitHub Codespaces[​](https://playwright.dev/docs/docker#connecting-using-novnc-and-github-codespaces "Direct link to Connecting using noVNC and GitHub Codespaces")
...
## Image tags[​](https://playwright.dev/docs/docker#image-tags "Direct link to Image tags")
...
### Base images[​](https://playwright.dev/docs/docker#base-images "Direct link to Base images")
...
#### Alpine[​](https://playwright.dev/docs/docker#alpine "Direct link to Alpine")
...
## Build your own image[​](https://playwright.dev/docs/docker#build-your-own-image "Direct link to Build your own image")

To run Playwright inside Docker, you need to have Node.js, [Playwright browsers](https://playwright.dev/docs/browsers#install-browsers) and [browser system dependencies](https://playwright.dev/docs/browsers#install-system-dependencies) installed. See the following Dockerfile:
