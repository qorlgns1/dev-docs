---
title: "Trace viewer"
description: "Playwright Trace Viewer is a GUI tool that lets you explore recorded Playwright traces of your tests, meaning you can go back and forward through each..."
---

Source URL: https://playwright.dev/docs/trace-viewer-intro

# Trace viewer | Playwright

## Introduction[​](https://playwright.dev/docs/trace-viewer-intro#introduction "Direct link to Introduction")
...
- [How to record a trace](https://playwright.dev/docs/trace-viewer-intro#recording-a-trace)
- [How to open the HTML report](https://playwright.dev/docs/trace-viewer-intro#opening-the-html-report)
- [How to open and view the trace](https://playwright.dev/docs/trace-viewer-intro#opening-the-trace)

## Recording a Trace[​](https://playwright.dev/docs/trace-viewer-intro#recording-a-trace "Direct link to Recording a Trace")
...
## Opening the HTML report[​](https://playwright.dev/docs/trace-viewer-intro#opening-the-html-report "Direct link to Opening the HTML report")
...
## Opening the trace[​](https://playwright.dev/docs/trace-viewer-intro#opening-the-trace "Direct link to Opening the trace")
...
To learn more about reporters, check out our detailed guide on reporters including the [HTML Reporter](https://playwright.dev/docs/test-reporters#html-reporter).

## Viewing the trace[​](https://playwright.dev/docs/trace-viewer-intro#viewing-the-trace "Direct link to Viewing the trace")
...
To learn more about traces, check out our detailed guide on [Trace Viewer](https://playwright.dev/docs/trace-viewer).

## What's next[​](https://playwright.dev/docs/trace-viewer-intro#whats-next "Direct link to What's next")

- [Run tests on CI with GitHub Actions](https://playwright.dev/docs/ci-intro)
- [Learn more about Trace Viewer](https://playwright.dev/docs/trace-viewer)
