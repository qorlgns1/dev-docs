...
description: "With Playwright you can run a single test, a set of tests, or all tests. Tests can be run on one browser or multiple browsers using the  flag. Tests r..."
---

Source URL: https://playwright.dev/docs/running-tests

# Running and debugging tests | Playwright

## Introduction[​](https://playwright.dev/docs/running-tests#introduction "Direct link to Introduction")
...
- [How to run tests from the command line](https://playwright.dev/docs/running-tests#command-line)
- [How to debug tests](https://playwright.dev/docs/running-tests#debugging-tests)
- [How to open the HTML test reporter](https://playwright.dev/docs/running-tests#test-reports)

## Running tests[​](https://playwright.dev/docs/running-tests#running-tests "Direct link to Running tests")

### Command line[​](https://playwright.dev/docs/running-tests#command-line "Direct link to Command line")
...
### Run tests in UI mode[​](https://playwright.dev/docs/running-tests#run-tests-in-ui-mode "Direct link to Run tests in UI mode")
...
### Run tests in headed mode[​](https://playwright.dev/docs/running-tests#run-tests-in-headed-mode "Direct link to Run tests in headed mode")
...
### Run tests on different browsers[​](https://playwright.dev/docs/running-tests#run-tests-on-different-browsers "Direct link to Run tests on different browsers")
...
### Run specific tests[​](https://playwright.dev/docs/running-tests#run-specific-tests "Direct link to Run specific tests")
...
### Run last failed tests[​](https://playwright.dev/docs/running-tests#run-last-failed-tests "Direct link to Run last failed tests")
...
### Run tests in VS Code[​](https://playwright.dev/docs/running-tests#run-tests-in-vs-code "Direct link to Run tests in VS Code")
...
## Debugging tests[​](https://playwright.dev/docs/running-tests#debugging-tests "Direct link to Debugging tests")
...
### Debug tests in UI mode[​](https://playwright.dev/docs/running-tests#debug-tests-in-ui-mode "Direct link to Debug tests in UI mode")
...
### Debug tests with the Playwright Inspector[​](https://playwright.dev/docs/running-tests#debug-tests-with-the-playwright-inspector "Direct link to Debug tests with the Playwright Inspector")
...
## Test reports[​](https://playwright.dev/docs/running-tests#test-reports "Direct link to Test reports")
...
## What's next[​](https://playwright.dev/docs/running-tests#whats-next "Direct link to What's next")
