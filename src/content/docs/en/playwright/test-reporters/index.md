---
title: "Reporters"
description: "Playwright Test comes with a few built-in reporters for different needs and ability to provide custom reporters. The easiest way to try out built-in r..."
---

Source URL: https://playwright.dev/docs/test-reporters

# Reporters | Playwright

## Introduction[​](https://playwright.dev/docs/test-reporters#introduction "Direct link to Introduction")
...
### Multiple reporters[​](https://playwright.dev/docs/test-reporters#multiple-reporters "Direct link to Multiple reporters")
...
### Reporters on CI[​](https://playwright.dev/docs/test-reporters#reporters-on-ci "Direct link to Reporters on CI")
...
## Built-in reporters[​](https://playwright.dev/docs/test-reporters#built-in-reporters "Direct link to Built-in reporters")

All built-in reporters show detailed information about failures, and mostly differ in verbosity for successful runs.

### List reporter[​](https://playwright.dev/docs/test-reporters#list-reporter "Direct link to List reporter")
...
### Line reporter[​](https://playwright.dev/docs/test-reporters#line-reporter "Direct link to Line reporter")
...
### Dot reporter[​](https://playwright.dev/docs/test-reporters#dot-reporter "Direct link to Dot reporter")
...
### HTML reporter[​](https://playwright.dev/docs/test-reporters#html-reporter "Direct link to HTML reporter")
...
### Blob reporter[​](https://playwright.dev/docs/test-reporters#blob-reporter "Direct link to Blob reporter")
...
### JSON reporter[​](https://playwright.dev/docs/test-reporters#json-reporter "Direct link to JSON reporter")
...
### JUnit reporter[​](https://playwright.dev/docs/test-reporters#junit-reporter "Direct link to JUnit reporter")
...
### GitHub Actions annotations[​](https://playwright.dev/docs/test-reporters#github-actions-annotations "Direct link to GitHub Actions annotations")
...
## Custom reporters[​](https://playwright.dev/docs/test-reporters#custom-reporters "Direct link to Custom reporters")
