---
title: "Clock"
description: "Accurately simulating time-dependent behavior is essential for verifying the correctness of applications. Learn more about clock emulation."
---
...
Accurately simulating time-dependent behavior is essential for verifying the correctness of applications. Learn more about [clock emulation](https://playwright.dev/docs/clock).

Note that clock is installed for the entire [BrowserContext](https://playwright.dev/docs/api/class-browsercontext "BrowserContext"), so the time in all the pages and iframes is controlled by the same clock.

---

## Methods[​](https://playwright.dev/docs/api/class-clock#methods "Direct link to Methods")

### fastForward[​](https://playwright.dev/docs/api/class-clock#clock-fast-forward "Direct link to fastForward")
...
### install[​](https://playwright.dev/docs/api/class-clock#clock-install "Direct link to install")
...
Fake timers are used to manually control the flow of time in tests. They allow you to advance time, fire timers, and control the behavior of time-dependent functions. See [clock.runFor()](https://playwright.dev/docs/api/class-clock#clock-run-for) and [clock.fastForward()](https://playwright.dev/docs/api/class-clock#clock-fast-forward) for more information.
...
For best results, install the clock before navigating the page and set it to a time slightly before the intended test time. This ensures that all timers run normally during page loading, preventing the page from getting stuck. Once the page has fully loaded, you can safely use [clock.pauseAt()](https://playwright.dev/docs/api/class-clock#clock-pause-at) to pause the clock.
...
### resume[​](https://playwright.dev/docs/api/class-clock#clock-resume "Direct link to resume")
...
### runFor[​](https://playwright.dev/docs/api/class-clock#clock-run-for "Direct link to runFor")
...
### setFixedTime[​](https://playwright.dev/docs/api/class-clock#clock-set-fixed-time "Direct link to setFixedTime")

Added in: v1.45 clock.setFixedTime

Makes `Date.now` and `new Date()` return fixed fake time at all times, keeps all the timers running.

Use this method for simple scenarios where you only need to test with a predefined time. For more advanced scenarios, use [clock.install()](https://playwright.dev/docs/api/class-clock#clock-install) instead. Read docs on [clock emulation](https://playwright.dev/docs/clock) to learn more.
...
### setSystemTime[​](https://playwright.dev/docs/api/class-clock#clock-set-system-time "Direct link to setSystemTime")
