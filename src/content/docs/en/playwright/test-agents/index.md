---
title: "Agents"
description: "Playwright comes with three Playwright Test Agents out of the box: 🎭 planner , 🎭 generator and 🎭 healer."
---

Source URL: https://playwright.dev/docs/test-agents

# Agents | Playwright

## Introduction[​](https://playwright.dev/docs/test-agents#introduction "Direct link to Introduction")
...
### Getting Started[​](https://playwright.dev/docs/test-agents#getting-started "Direct link to Getting Started")
...
## 🎭 Planner[​](https://playwright.dev/docs/test-agents#-planner "Direct link to 🎭 Planner")
...
![planner prompt](https://playwright.dev/assets/ideal-img/planner-prompt.3e77e0f.640.png)
...
## 🎭 Generator[​](https://playwright.dev/docs/test-agents#-generator "Direct link to 🎭 Generator")
...
![generator prompt](https://playwright.dev/assets/ideal-img/generator-prompt.d16aa4b.640.png)
...
## 🎭 Healer[​](https://playwright.dev/docs/test-agents#-healer "Direct link to 🎭 Healer")
...
![healer prompt](https://playwright.dev/assets/ideal-img/healer-prompt.5677507.640.png)

**Output**

- A passing test, or a skipped test if the healer believes the that functionality is broken.

## Artifacts and Conventions[​](https://playwright.dev/docs/test-agents#artifacts-and-conventions "Direct link to Artifacts and Conventions")
...
### Agent Definitions[​](https://playwright.dev/docs/test-agents#agent-definitions "Direct link to Agent Definitions")
...
### Specs in `specs/`[​](https://playwright.dev/docs/test-agents#specs-in-specs "Direct link to specs-in-specs")
...
### Tests in `tests/`[​](https://playwright.dev/docs/test-agents#tests-in-tests "Direct link to tests-in-tests")

Generated Playwright tests, aligned one-to-one with specs wherever feasible.

### Seed tests `seed.spec.ts`[​](https://playwright.dev/docs/test-agents#seed-tests-seedspects "Direct link to seed-tests-seedspects")
