...
description: "Playwright executes tests in isolated environments called browser contexts. This isolation model improves reproducibility and prevents cascading test ..."
---

Source URL: https://playwright.dev/docs/auth

# Authentication | Playwright

## Introduction[​](https://playwright.dev/docs/auth#introduction "Direct link to Introduction")
...
## Core concepts[​](https://playwright.dev/docs/auth#core-concepts "Direct link to Core concepts")
...
## Basic: shared account in all tests[​](https://playwright.dev/docs/auth#basic-shared-account-in-all-tests "Direct link to Basic: shared account in all tests")
...
### Authenticating in UI mode[​](https://playwright.dev/docs/auth#authenticating-in-ui-mode "Direct link to Authenticating in UI mode")
...
## Moderate: one account per parallel worker[​](https://playwright.dev/docs/auth#moderate-one-account-per-parallel-worker "Direct link to Moderate: one account per parallel worker")
...
## Advanced scenarios[​](https://playwright.dev/docs/auth#advanced-scenarios "Direct link to Advanced scenarios")

### Authenticate with API request[​](https://playwright.dev/docs/auth#authenticate-with-api-request "Direct link to Authenticate with API request")
...
### Multiple signed in roles[​](https://playwright.dev/docs/auth#multiple-signed-in-roles "Direct link to Multiple signed in roles")
...
### Testing multiple roles together[​](https://playwright.dev/docs/auth#testing-multiple-roles-together "Direct link to Testing multiple roles together")
...
### Testing multiple roles with POM fixtures[​](https://playwright.dev/docs/auth#testing-multiple-roles-with-pom-fixtures "Direct link to Testing multiple roles with POM fixtures")
...
### Session storage[​](https://playwright.dev/docs/auth#session-storage "Direct link to Session storage")
...
### Avoid authentication in some tests[​](https://playwright.dev/docs/auth#avoid-authentication-in-some-tests "Direct link to Avoid authentication in some tests")
