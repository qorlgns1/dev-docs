---
title: "WebView2"
description: "The following will explain how to use Playwright with Microsoft Edge WebView2. WebView2 is a WinForms control, which will use Microsoft Edge under the..."
---

Source URL: https://playwright.dev/docs/webview2

# WebView2 | Playwright

## Introduction[​](https://playwright.dev/docs/webview2#introduction "Direct link to Introduction")
...
## Overview[​](https://playwright.dev/docs/webview2#overview "Direct link to Overview")
...
## Writing and running tests[​](https://playwright.dev/docs/webview2#writing-and-running-tests "Direct link to Writing and running tests")
...
Using the following, Playwright will run your WebView2 application as a sub-process, assign a unique user data directory to it and provide the [Page](https://playwright.dev/docs/api/class-page "Page") instance to your test:
...
## Debugging[​](https://playwright.dev/docs/webview2#debugging "Direct link to Debugging")
...
For debugging tests, see the Playwright [Debugging guide](https://playwright.dev/docs/debug).
