...
description: "Playwright tests can be executed in CI environments. We have created sample configurations for common CI providers."
---
...
#### On push/pull_request[​](https://playwright.dev/docs/ci#on-pushpull_request "Direct link to On push/pull_request")
...
#### On push/pull_request (sharded)[​](https://playwright.dev/docs/ci#on-pushpull_request-sharded "Direct link to On push/pull_request (sharded)")
