---
title: "Setting up CI"
description: "Playwright tests can be run on any CI provider. This guide covers one way of running tests on GitHub using GitHub Actions. If you would like to learn ..."
---

Source URL: https://playwright.dev/docs/ci-intro
