...
description: "Playwright can connect to Selenium Grid Hub that runs Selenium 4 to launch Google Chrome or Microsoft Edge browser, instead of running browser on the ..."
---

Source URL: https://playwright.dev/docs/selenium-grid

# Selenium Grid (experimental) | Playwright
