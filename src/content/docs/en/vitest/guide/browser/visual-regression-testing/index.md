...
description: "Vitest can run visual regression tests out of the box. It captures screenshots"
---

Source URL: https://vitest.dev/guide/browser/visual-regression-testing
...
[Test Projects](https://vitest.dev/guide/projects) instead and run them using:
...
PR automatically _(chaos!)_. Instead, create a
...
The cleanest approach is using [Test Projects](https://vitest.dev/guide/projects):
