...
description: "This page provides information about the browser mode feature in the Vitest API, which allows you to run your tests in the browser natively, providing..."
---

Source URL: https://vitest.dev/guide/browser
...
::: tip
If you are looking for documentation for `expect`, `vi` or any general API like test projects or type testing, refer to the ["Getting Started" guide](https://vitest.dev/guide/).
:::
...
If you need to run some tests using Node-based runner, you can define a [`projects`](https://vitest.dev/guide/projects) option with separate configurations for different testing strategies:
...
When using headless mode, Vitest won't open the UI automatically. If you want to continue using the UI but have tests run headlessly, you can install the [`@vitest/ui`](https://vitest.dev/guide/ui) package and pass the `--ui` flag when running Vitest.
...
In such situations, Vitest provides default mocks with default returned values for these APIs. This ensures that if the user accidentally uses synchronous popup web APIs, the execution would not hang. However, it's still recommended for the user to mock these web APIs for a better experience. Read more in [Mocking](https://vitest.dev/guide/mocking).
