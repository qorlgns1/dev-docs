---
title: "Test Context"
description: "Inspired by Playwright Fixtures, Vitest's test context allows you to define utils, states, and fixtures that can be used in your tests."
---

Source URL: https://vitest.dev/guide/test-context
...
Add a [test annotation](https://vitest.dev/guide/test-annotations) that will be displayed by your [reporter](https://vitest.dev/config/#reporters).
...
Since Vitest 3, you can provide different values in different [projects](https://vitest.dev/guide/projects). To enable this feature, pass down `{ injected: true }` to the options. If the key is not specified in the [project configuration](https://vitest.dev/config/#provide), then the default value will be used.
