...
description: "Vitest provides a way to run tests within your source code along side the implementation, similar to Rust's module tests."
---

Source URL: https://vitest.dev/guide/in-source
