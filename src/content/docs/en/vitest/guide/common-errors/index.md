---
title: "Common Errors"
description: "If you receive an error that module cannot be found, it might mean several different things:"
---

Source URL: https://vitest.dev/guide/common-errors
...
You can learn more about Vite environments and Vitest environments in [`environment`](https://vitest.dev/config/environment).
:::
