---
title: "Coverage"
description: "Vitest supports Native code coverage via  and instrumented code coverage via ."
---

Source URL: https://vitest.dev/guide/coverage
...
To include uncovered files in the report, you'll need to configure [`coverage.include`](https://vitest.dev/config/#coverage-include) with a pattern that will pick your source files:
