---
title: "Mocking"
description: 'When writing tests it''s only a matter of time before you need to create a "fake" version of an internal — or external — service. This is commonly refe...'
---

Source URL: https://vitest.dev/guide/mocking
...
::: warning
This will not work in the Browser Mode. For a workaround, see [Limitations](https://vitest.dev/guide/browser/#spying-on-module-exports).
:::
...
::: warning
`vi.spyOn` example will not work in the Browser Mode. For a workaround, see [Limitations](https://vitest.dev/guide/browser/#spying-on-module-exports).
:::
