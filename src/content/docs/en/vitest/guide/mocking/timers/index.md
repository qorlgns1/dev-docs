---
title: "Timers"
description: 'When we test code that involves timeouts or intervals, instead of having our tests wait it out or timeout, we can speed up our tests by using "fake" t...'
---

Source URL: https://vitest.dev/guide/mocking/timers
