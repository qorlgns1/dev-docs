...
description: "Because Vitest runs in Node, mocking network requests is tricky; web APIs are not available, so we need something that will mimic network behavior for..."
---

Source URL: https://vitest.dev/guide/mocking/requests
