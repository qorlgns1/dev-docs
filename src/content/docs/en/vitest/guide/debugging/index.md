---
title: "Debugging"
description: "When debugging tests you might want to use following options:"
---

Source URL: https://vitest.dev/guide/debugging
...
- [`--test-timeout=0`](https://vitest.dev/guide/cli#testtimeout) to prevent tests from timing out when stopping at breakpoints
- [`--no-file-parallelism`](https://vitest.dev/guide/cli#fileparallelism) to prevent test files from running parallel
...
To debug [Vitest Browser Mode](https://vitest.dev/guide/browser/index.md), pass `--inspect` or `--inspect-brk` in CLI or define it in your Vitest configuration:
