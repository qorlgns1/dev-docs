---
title: "Test Projects [​](https://vitest.dev/guide/workspace#test-projects)"
description: "This feature is also known as a . The  is deprecated since 3.2 and replaced with the  configuration. They are functionally the same."
---

Source URL: https://vitest.dev/guide/workspace

# Test Projects [​](https://vitest.dev/guide/workspace#test-projects)
...
## Defining Projects [​](https://vitest.dev/guide/workspace#defining-projects)
...
## Running Tests [​](https://vitest.dev/guide/workspace#running-tests)
...
## Configuration [​](https://vitest.dev/guide/workspace#configuration)
