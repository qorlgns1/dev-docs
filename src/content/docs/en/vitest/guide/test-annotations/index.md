...
description: "Vitest supports annotating your tests with custom messages and files via the  API. These annotations will be attached to the test case and passed down..."
---

Source URL: https://vitest.dev/guide/test-annotations

# Test Annotations

Vitest supports annotating your tests with custom messages and files via the [`context.annotate`](https://vitest.dev/guide/test-context#annotate) API. These annotations will be attached to the test case and passed down to reporters in the [`onTestAnnotate`](https://vitest.dev/api/advanced/reporters#ontestannotate) hook.
