---
title: "Custom Pool advanced {#custom-pool}"
description: "This is an advanced, experimental and very low-level API. If you just want to run tests, you probably don't need this. It is primarily used by library..."
---

Source URL: https://vitest.dev/guide/advanced/pool

# Custom Pool advanced {#custom-pool}

::: warning
This is an advanced, experimental and very low-level API. If you just want to [run tests](https://vitest.dev/guide/), you probably don't need this. It is primarily used by library authors.
:::
...
If you need to run tests in different pools, use the [`projects`](https://vitest.dev/guide/projects) feature:
