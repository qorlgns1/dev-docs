---
title: "Parallelism"
description: "By default, Vitest runs *test files* in parallel. Depending on the specified , Vitest uses a different mechanism to parallelize test files:"
---

Source URL: https://vitest.dev/guide/parallelism
