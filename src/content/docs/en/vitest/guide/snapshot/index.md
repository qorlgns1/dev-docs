---
title: "Snapshot"
description: "Learn Snapshot by video from Vue School"
---

Source URL: https://vitest.dev/guide/snapshot
...
In light of this, we introduced [`toMatchFileSnapshot()`](https://vitest.dev/api/expect#tomatchfilesnapshot) to explicitly match against a file. This allows you to assign any file extension to the snapshot file, and makes them more readable.
...
For visual regression testing of UI components and pages, Vitest provides built-in support through [browser mode](https://vitest.dev/guide/browser/) with the [`toMatchScreenshot()`](https://vitest.dev/api/browser/assertions#tomatchscreenshot-experimental) assertion:
...
This captures screenshots and compares them against reference images to detect unintended visual changes. Learn more in the [Visual Regression Testing guide](https://vitest.dev/guide/browser/visual-regression-testing).
