...
description: "Since Vitest is compatible with both Chai and Jest, you can use either the  API or , whichever you prefer."
---

Source URL: https://vitest.dev/guide/extending-matchers
...
Contains a reference to [the `Test` runner task](https://vitest.dev/api/advanced/runner#tasks) when available.
