...
description: "If you are using Vite and have a  file, Vitest will read it to match with the plugins and setup as your Vite app. If you want to have a different conf..."
---

Source URL: https://vitest.dev/config
...
Configuration options that are not supported inside a [project](https://vitest.dev/guide/projects) config have icon next to them. This means they can only be set in the root Vitest config.
