...
description: "Path to a custom snapshot environment implementation. This is useful if you are running your tests in an environment that doesn't support Node.js APIs..."
---

Source URL: https://vitest.dev/config/snapshotenvironment
