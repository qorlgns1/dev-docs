---
title: "css.include"
description: "Configure if CSS should be processed. When excluded, CSS files will be replaced with empty strings to bypass the subsequent processing. CSS Modules wi..."
---

Source URL: https://vitest.dev/config/css
...
::: warning
This option is not applied to [browser tests](https://vitest.dev/guide/browser/).
:::
