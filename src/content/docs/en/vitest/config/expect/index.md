---
title: "expect"
description: "The same as calling  at the start of every test. This makes sure that no test will pass accidentally."
---

Source URL: https://vitest.dev/config/expect
...
::: warning
When you run tests with `sequence.concurrent` and `expect.requireAssertions` set to `true`, you should use [local expect](https://vitest.dev/guide/test-context.html#expect) instead of the global one. Otherwise, this may cause false negatives in [some situations (#8469)](https://github.com/vitest-dev/vitest/issues/8469).
:::
