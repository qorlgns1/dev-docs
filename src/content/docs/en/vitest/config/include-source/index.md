---
title: "includeSource"
description: "A list of glob patterns that match your in-source test files. These patterns are resolved relative to the  ( by default)."
---

Source URL: https://vitest.dev/config/include-source
...
A list of [glob patterns](https://superchupu.dev/tinyglobby/comparison) that match your [in-source test files](https://vitest.dev/guide/in-source). These patterns are resolved relative to the [`root`](https://vitest.dev/config/root) ([`process.cwd()`](https://nodejs.org/api/process.html#processcwd) by default).
