...
Source URL: https://vitest.dev/config/onunhandlederror
...
To report unhandled errors without affecting the test outcome, use the [`dangerouslyIgnoreUnhandledErrors`](https://vitest.dev/config/dangerouslyignoreunhandlederrors) option instead.
