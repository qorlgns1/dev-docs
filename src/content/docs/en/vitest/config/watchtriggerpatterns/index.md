...
description: "Vitest reruns tests based on the module graph which is populated by static and dynamic  statements. However, if you are reading from the file system o..."
---

Source URL: https://vitest.dev/config/watchtriggerpatterns
