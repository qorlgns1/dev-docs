---
title: "cache"
description: "Use this option if you want to disable the cache feature. At the moment Vitest stores cache for test results to run the longer and failed tests first."
---

Source URL: https://vitest.dev/config/cache
