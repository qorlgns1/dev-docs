---
title: "environment"
description: "The environment that will be used for testing. The default environment in Vitest"
---

Source URL: https://vitest.dev/config/environment
...
To define custom options for your environment, use [`environmentOptions`](https://vitest.dev/config/environmentoptions).
