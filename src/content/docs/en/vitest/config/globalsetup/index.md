---
title: "globalSetup"
description: "Path to global setup files relative to project root."
---

Source URL: https://vitest.dev/config/globalsetup

# globalSetup

- **Type:** `string | string[]`

Path to global setup files relative to project [root](https://vitest.dev/config/root).
...
If you need to execute code in the same process as tests, use [`setupFiles`](https://vitest.dev/config/setupfiles) instead, but note that it runs before every test file.
:::
