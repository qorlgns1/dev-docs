...
description: "Glob pattern of file paths that will trigger the whole suite rerun. When paired with the  argument will run the whole test suite if the trigger is fou..."
---

Source URL: https://vitest.dev/config/forcereruntriggers
