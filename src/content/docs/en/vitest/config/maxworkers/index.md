---
title: "maxWorkers"
description: "Defines the maximum concurrency for test workers. Accepts either a number or a percentage string."
---

Source URL: https://vitest.dev/config/maxworkers

# maxWorkers

- **Type:** `number | string`
- **Default:**
  - if [`watch`](https://vitest.dev/config/watch) is disabled, uses all available parallelism
  - if [`watch`](https://vitest.dev/config/watch) is enabled, uses half of all available parallelism
