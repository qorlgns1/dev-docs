...
description: "Custom scripts that should be injected into the orchestrator HTML before test iframes are initiated. This HTML document only sets up iframes and doesn..."
---

Source URL: https://vitest.dev/config/browser/orchestratorscripts
