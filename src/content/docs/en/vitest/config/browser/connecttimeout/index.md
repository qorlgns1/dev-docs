...
description: "The timeout in milliseconds. If connection to the browser takes longer, the test suite will fail."
---

Source URL: https://vitest.dev/config/browser/connecttimeout
