...
Source URL: https://vitest.dev/config/browser/webdriverio

# Configuring WebdriverIO

::: info Playwright vs WebdriverIO
If you do not already use WebdriverIO in your project, we recommend starting with [Playwright](https://vitest.dev/config/browser/playwright) as it is easier to configure and has more flexible API.
:::
...
Note that Vitest will ignore `capabilities.browserName` — use [`test.browser.instances.browser`](https://vitest.dev/config/browser/instances#browser) instead.
:::
