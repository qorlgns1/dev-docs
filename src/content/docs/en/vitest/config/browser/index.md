---
title: "Browser Config Reference"
description: "You can change the browser configuration by updating the  field in your config file. An example of a simple config file:"
---

Source URL: https://vitest.dev/config/browser

# Browser Config Reference

You can change the browser configuration by updating the `test.browser` field in your [config file](https://vitest.dev/config/). An example of a simple config file:
...
Please, refer to the ["Config Reference"](https://vitest.dev/config/) article for different config examples.
...
- **Type:** `boolean`
- **Default:** the same as [`--isolate`](https://vitest.dev/config/#isolate)
- **CLI:** `--browser.isolate`, `--browser.isolate=false`

Run every test in a separate iframe.

::: danger DEPRECATED
This option is deprecated. Use [`isolate`](https://vitest.dev/config/#isolate) instead.
:::
...
Options for built-in [browser locators](https://vitest.dev/api/browser/locators).
...
Custom [commands](https://vitest.dev/api/browser/commands) that can be imported during browser tests from `vitest/browser`.
...
::: danger WARNING
This option is supported only by the [**playwright**](https://vitest.dev/config/browser/playwright) provider.
:::
...
[`toMatchScreenshot` assertion](https://vitest.dev/api/browser/assertions.html#tomatchscreenshot).
...
[All options available in the `toMatchScreenshot` assertion](https://vitest.dev/api/browser/assertions#options)
...
- `screenshotDirectory: string`
  ...
  [`browser.screenshotDirectory`](https://vitest.dev/config/browser/screenshotdirectory),
  if none is provided, its default value.

- `root: string`

  Absolute path to the project's [`root`](https://vitest.dev/config/#root).

- `testFileDirectory: string`

  Path to the test file, relative to the project's [`root`](https://vitest.dev/config/#root).
...
- `testName: string`
  ...
  The [`test`](https://vitest.dev/api/#test)'s name, including parent
  [`describe`](https://vitest.dev/api/#describe), sanitized.

- `attachmentsDir: string`

  The value provided to [`attachmentsDir`](https://vitest.dev/config/#attachmentsdir), if none is
...
The `createDiff` option indicates whether a diff image is needed. During [stable screenshot detection](https://vitest.dev/guide/browser/visual-regression-testing#how-visual-tests-work), Vitest calls comparators with `createDiff: false` to avoid unnecessary work.
