...
description: "You can use ,  or a custom coverage solution for coverage collection."
---

Source URL: https://vitest.dev/config/coverage

# coverage {#coverage}

You can use [`v8`](https://vitest.dev/guide/coverage.html#v8-provider), [`istanbul`](https://vitest.dev/guide/coverage.html#istanbul-provider) or [a custom coverage solution](https://vitest.dev/guide/coverage#custom-coverage-provider) for coverage collection.
...
To preview the coverage report in the output of [HTML reporter](https://vitest.dev/guide/reporters.html#html-reporter), this option must be set as a sub-directory of the html report directory (for example `./html/coverage`).
