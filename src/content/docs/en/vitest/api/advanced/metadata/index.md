...
description: "If you are developing a custom reporter or using Vitest Node.js API, you might find it useful to pass data from tests that are being executed in vario..."
---

Source URL: https://vitest.dev/api/advanced/metadata
