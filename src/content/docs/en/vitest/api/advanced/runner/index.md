---
title: "Runner API advanced"
description: "This is advanced API. If you just want to run tests, you probably don't need this. It is primarily used by library authors."
---

Source URL: https://vitest.dev/api/advanced/runner
...
::: warning
The "Runner Tasks API" is experimental and should primarily be used only in the test runtime. Vitest also exposes the ["Reported Tasks API"](https://vitest.dev/api/advanced/test-module), which should be preferred when working in the main thread (inside the reporter, for example).
