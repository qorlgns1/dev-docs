...
description: "represents a collection of top-level suites and tests in a suite or a module. It also provides useful methods to iterate over itself."
---

Source URL: https://vitest.dev/api/advanced/test-collection

# TestCollection

`TestCollection` represents a collection of top-level [suites](https://vitest.dev/api/advanced/test-suite) and [tests](https://vitest.dev/api/advanced/test-case) in a suite or a module. It also provides useful methods to iterate over itself.
