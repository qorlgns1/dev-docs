---
title: "Assertion API"
description: "Vitest provides a wide range of DOM assertions out of the box forked from  library with the added support for locators and built-in retry-ability."
---

Source URL: https://vitest.dev/api/browser/assertions
...
If you are using [TypeScript](https://vitest.dev/guide/browser/#typescript) or want to have correct type hints in `expect`, make sure you have `vitest/browser` referenced somewhere. If you never imported from there, you can add a `reference` comment in any file that's covered by your `tsconfig.json`:
...
[`expect.stringContaining`](https://vitest.dev/api/expect#expect-stringcontaining) or [`expect.stringMatching`](https://vitest.dev/api/expect#expect-stringmatching).
...
partial match using [`expect.stringContaining`](https://vitest.dev/api/expect#expect-stringcontaining) or [`expect.stringMatching`](https://vitest.dev/api/expect#expect-stringmatching).
...
[Vitest config](https://vitest.dev/config/browser/expect#tomatchscreenshot).
:::
...
[Visual Regression Testing guide](https://vitest.dev/guide/browser/visual-regression-testing) to
...
- `screenshotOptions: object`
  ...
  [`locator.screenshot()`](https://vitest.dev/api/browser/locators.html#screenshot), except for:
  - `'base64'`
  - `'path'`
  - `'save'`
  - `'type'`
