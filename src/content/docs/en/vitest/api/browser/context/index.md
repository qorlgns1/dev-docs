---
title: "Context API"
description: "Vitest exposes a context module via  entry point. As of 2.0, it exposes a small set of utilities that might be useful to you in tests."
---

Source URL: https://vitest.dev/api/browser/context
...
::: tip
The `userEvent` API is explained in detail at [Interactivity API](https://vitest.dev/api/browser/interactivity).
:::
...
::: tip
This API is explained in detail at [Commands API](https://vitest.dev/api/browser/commands).
:::
...
Use [Commands API](https://vitest.dev/api/browser/commands) if you need to have access to Playwright's `page` object.
:::
...
::: tip
The `getBy*` API is explained at [Locators API](https://vitest.dev/api/browser/locators).
:::
