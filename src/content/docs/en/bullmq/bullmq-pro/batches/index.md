---
title: 'Batches'
description: 'It is possible to configure workers so that instead of processing one job at a time they can process up to a number of jobs (a so-called *batch*) in o...'
---
