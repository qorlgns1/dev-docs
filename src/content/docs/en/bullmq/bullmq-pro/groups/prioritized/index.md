---
title: 'Prioritized intra-groups'
description: 'BullMQ Pro supports priorities per group. A job is prioritized in a group when group and priority options are provided *together*.'
---
