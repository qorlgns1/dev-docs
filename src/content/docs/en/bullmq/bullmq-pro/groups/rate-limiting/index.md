---
title: 'Rate limiting'
description: 'A useful feature when using groups is to be able to rate limit the groups independently of each other, so you can evenly process the jobs belonging to...'
---

Source URL: https://docs.bullmq.io/bullmq-pro/groups/rate-limiting
