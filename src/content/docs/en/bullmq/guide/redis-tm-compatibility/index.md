...
description: 'There are several alternatives for Redis and even though BullMQ is full Redis™ compliant with version 6.2.0 or newer, not all the alternatives are goi...'
---

Source URL: https://docs.bullmq.io/guide/redis-tm-compatibility
