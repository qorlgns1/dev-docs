---
title: 'Connections'
description: 'In order to start working with a Queue, a connection to a Redis instance is necessary. BullMQ uses the node module ioredis, and the options you pass t...'
---

Source URL: https://docs.bullmq.io/guide/connections
