...
description: 'There are some options that can be used on all Job Schedulers, to control some aspects of the repetitions. Lets review them one by one:'
---

Source URL: https://docs.bullmq.io/guide/job-schedulers/repeat-options
