...
description: 'BullMQ supports pausing queues *globally* or *locally*. When a queue is paused *globally* no workers will pick up any jobs from the queue. When you pa...'
---

Source URL: https://docs.bullmq.io/guide/workers/pausing-queues
