...
description: 'It is also possible to define workers to run on a separate process. We call these processors *sandboxed*, because they run isolated from the rest of t...'
---
