---
title: 'Running a simple example'
description: 'For this simple example we will create a producer that will add a couple of jobs, but it will add them in bulks instead of one by one, this will help ...'
---

Source URL: https://docs.bullmq.io/guide/telemetry/running-a-simple-example
