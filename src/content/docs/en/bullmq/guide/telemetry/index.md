---
title: 'Telemetry'
description: 'BullMQ provides a Telemetry interface that can be used to integrate it with any external telemetry backends. Currently we support the OpenTelemetry sp...'
---

Source URL: https://docs.bullmq.io/guide/telemetry
