---
title: 'Events'
description: 'All classes in BullMQ emit useful events that inform on the lifecycles of the jobs that are running in the queue. Every class is an  and emits differe...'
---
