...
description: 'In BullMQ, creating a generic distributed realtime event emitter is possible by using our QueueEventsProducer class.'
---

Source URL: https://docs.bullmq.io/guide/events/create-custom-events
