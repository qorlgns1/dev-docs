...
description: 'Sometimes it is necessary to atomically add flows in bulk. For example, there could be a requirement that all the flows must be created or none of the...'
---

Source URL: https://docs.bullmq.io/guide/flows/adding-bulks
