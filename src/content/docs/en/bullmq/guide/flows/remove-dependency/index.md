...
description: 'In some situations, you may have a parent job and need to remove the relationship when one of its children fail.'
---

Source URL: https://docs.bullmq.io/guide/flows/remove-dependency
