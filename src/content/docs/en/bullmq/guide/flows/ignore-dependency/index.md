...
description: 'In some situations, you may have a parent job and need to ignore when one of its children fail.'
---

Source URL: https://docs.bullmq.io/guide/flows/ignore-dependency
