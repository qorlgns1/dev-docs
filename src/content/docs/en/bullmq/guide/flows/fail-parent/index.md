---
title: 'Fail Parent'
description: 'In certain workflows, you may need a parent job to fail immediately if any of its child jobs fail. The  option allows you to achieve this behaviour. W...'
---
