---
title: 'LIFO'
description: 'In some cases, it is useful to process jobs in a LIFO (*Last-in, First-Out*) fashion. This means that the newest jobs added to the queue will be proce...'
---
