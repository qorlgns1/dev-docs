---
title: 'Delayed'
description: 'Delayed jobs are a special type of job that is placed into a special "delayed set", instead of being processed as fast as possible. After the delay ti...'
---

Source URL: https://docs.bullmq.io/guide/jobs/delayed
