---
title: 'FIFO'
description: 'The first type of job we are going to describe is the FIFO (*First-In, First-Out*) type. This is the standard type when adding jobs to a queue. The jo...'
---
