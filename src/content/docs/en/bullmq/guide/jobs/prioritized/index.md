---
title: 'Prioritized'
description: 'Jobs can also include a  option. Using priorities, job processing order will be affected by the specified  instead of following a FIFO or LIFO pattern...'
---
