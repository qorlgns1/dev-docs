---
title: 'Retrying jobs'
description: 'BullMQ provides a  method that allows you to programmatically retry jobs that have already completed or failed. This is different from the automatic r...'
---
