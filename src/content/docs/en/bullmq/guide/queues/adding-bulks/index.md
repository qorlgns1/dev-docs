...
description: 'Sometimes it is necessary to add many jobs atomically. For example, there could be a requirement that all the jobs must be placed in the queue or none...'
---

Source URL: https://docs.bullmq.io/guide/queues/adding-bulks
