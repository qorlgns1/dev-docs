---
title: 'Queues'
description: 'A Queue is nothing more than a list of jobs waiting to be processed. The jobs can be small, message like, so that the queue can be used as a message b...'
---

Source URL: https://docs.bullmq.io/guide/queues
