---
title: 'Introduction'
description: 'The PHP package provides a Queue client that allows you to add jobs to BullMQ queues from your PHP applications. These jobs can then be processed by w...'
---
