---
title: 'Redis cluster'
description: "Bull internals require atomic operations that span different keys. This behavior breaks Redis's rules for cluster configurations. However, it is still..."
---

Source URL: https://docs.bullmq.io/bull/patterns/redis-cluster
