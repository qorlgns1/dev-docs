---
title: 'Manually fetching jobs'
description: 'If you want to manually fetch the jobs from the queue instead of letting the automatic processor taking care of it, this pattern is for you.'
---
