---
title: 'Throttle jobs'
description: 'Sometimes, you may want to enqueue a job in reaction to a frequently occurring event, without running that job for *every* event. For example, you may...'
---
