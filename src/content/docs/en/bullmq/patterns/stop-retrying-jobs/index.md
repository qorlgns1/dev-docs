...
description: 'When a processor throws an exception that is considered unrecoverable, you should use the  class. In this case, BullMQ will just move the job to the f...'
---
