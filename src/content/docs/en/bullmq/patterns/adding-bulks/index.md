---
title: 'Adding jobs in bulk across different queues'
description: 'Sometimes it is necessary to atomically add jobs to different queues in bulk. For example, there could be a requirement that all the jobs must be crea...'
---
