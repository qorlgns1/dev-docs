...
description: 'By design, BullMQ reconnects to Redis automatically. If jobs are added to a queue while the queue instance is disconnected from Redis, the  command wi...'
---

Source URL: https://docs.bullmq.io/patterns/failing-fast-when-redis-is-down
