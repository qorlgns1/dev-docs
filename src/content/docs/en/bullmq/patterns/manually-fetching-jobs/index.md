...
description: 'When a Worker is instantiated, the most common usage is to specify a process function so that the worker will automatically process the jobs that arri...'
---

Source URL: https://docs.bullmq.io/patterns/manually-fetching-jobs
