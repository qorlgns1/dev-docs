...
Use JavaScript database drivers via [driver adapters](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/database-drivers#driver-adapters):
...
**Timeout configuration:** Configure connection and pool timeouts via your [driver adapter](https://docs.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-pool) (e.g. `connectionTimeoutMillis` for `pg`).
...
See [connection pool guide](https://docs.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-pool#postgresql-using-the-pg-driver-adapter) for configuration.
