...
Use the `node-mssql` JavaScript database driver via [driver adapters](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/database-drivers#driver-adapters):
...
See [connection pool guide](https://docs.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/connection-pool#sql-server-using-the-mssql-driver) for configuration.
...
See [full type mapping reference](https://docs.prisma.io/docs/orm/reference/prisma-schema-reference#model-field-scalar-types) for complete details.
...
With circular model references, you must use [`NoAction` referential actions](https://docs.prisma.io/docs/orm/prisma-schema/data-model/relations/referential-actions#special-rules-for-sql-server-and-mongodb) to avoid validation errors.
