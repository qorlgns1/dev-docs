...
Source URL: https://docs.prisma.io/docs/orm/prisma-schema/postgresql-extensions
...
Run the following command to create an empty migration that you can [customize](https://docs.prisma.io/docs/orm/prisma-migrate/workflows/customizing-migrations):
