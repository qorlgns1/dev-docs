...
description: "The Prisma schema is the main method of configuration when using Prisma. It is typically called schema.prisma and contains your database connection an..."
---

Source URL: https://docs.prisma.io/docs/orm/prisma-schema/overview
...
- [**Data sources**](https://docs.prisma.io/docs/orm/prisma-schema/overview/data-sources): Specify the details of the data sources Prisma ORM should connect to (e.g. a PostgreSQL database)
- [**Generators**](https://docs.prisma.io/docs/orm/prisma-schema/overview/generators): Specifies what clients should be generated based on the data model (e.g. Prisma Client)
- **Data model definition**](https://docs.prisma.io/docs/orm/prisma-schema/data-model/models): Specifies your application [models](https://docs.prisma.io/docs/orm/prisma-schema/data-model/models#defining-models) (the shape of the data per data source) and their [relations

It is typically a single file called `schema.prisma` (or multiple files with `.prisma` file extension) that is stored in a defined but customizable [location](https://docs.prisma.io/docs/orm/prisma-schema/overview/location). You can also [organize your Prisma schema in multiple files](https://docs.prisma.io/docs/orm/prisma-schema/overview/location#multi-file-prisma-schema) if you prefer that.

See the [Prisma schema API reference](https://docs.prisma.io/docs/orm/reference/prisma-schema-reference) for detailed information about each section of the schema.
...
You can also [use environment variables](https://docs.prisma.io/docs/orm/prisma-schema/overview#accessing-environment-variables-from-the-schema) inside the schema to provide configuration options when a CLI command is invoked.
...
- Several [native data type attributes](https://docs.prisma.io/docs/orm/prisma-schema/data-model/models#native-types-mapping) (`@db.VarChar(255)`, `@db.ObjectId`)
...
See [Environment variables](https://docs.prisma.io/docs/orm/more/dev-environment/environment-variables) for more information about how to use an `.env` file during development.
...
- Run the [`prisma format`](https://docs.prisma.io/docs/orm/reference/prisma-cli-reference#format) command.
...
There are no configuration options - [formatting rules](https://docs.prisma.io/docs/orm/prisma-schema/overview#formatting-rules) are fixed (similar to Golang's `gofmt` but unlike Javascript's `prettier`):
