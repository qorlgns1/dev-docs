...
Source URL: https://docs.prisma.io/docs/orm/prisma-schema/overview/location
...
1. The location specified by the [`--schema` flag](https://docs.prisma.io/docs/orm/reference/prisma-cli-reference), which is available when you `introspect`, `generate`, `migrate`, and `studio`:
...
### Watch video: Multi-file Prisma schema
...
- set the `schema` property in [`prisma.config.ts`](https://docs.prisma.io/docs/orm/reference/prisma-config-reference#schema) (for Prisma ORM v7):
...
We recommend using the [Prisma Config file](https://docs.prisma.io/docs/orm/reference/prisma-config-reference#schema) to specify the location of your Prisma schema. This is the most flexible way to specify the location of your Prisma schema alongside other configuration options.
