...
Source URL: https://docs.prisma.io/docs/orm/prisma-schema/data-model/multi-schema
...
Sometimes, you might not want Prisma ORM to manage specific tables, such as ones handled by another team or service (e.g., Auth0 or Clerk tables). In such cases, you can mark these as **externally managed tables** using the `tables.external` configuration option in your [Prisma Config file](https://docs.prisma.io/docs/orm/reference/prisma-config-reference#tablesexternal-and-enumsexternal). Learn more about [externally managed tables](https://docs.prisma.io/docs/orm/prisma-schema/data-model/externally-managed-tables).
