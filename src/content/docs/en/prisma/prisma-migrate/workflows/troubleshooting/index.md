...
Source URL: https://docs.prisma.io/docs/orm/prisma-migrate/workflows/troubleshooting
...
- Patching / hotfixing production databases
...
You should [never purposefully delete or edit a migration](https://docs.prisma.io/docs/orm/prisma-migrate/understanding-prisma-migrate/migration-histories#do-not-edit-or-delete-migrations-that-have-been-applied), as this might result in discrepancies between development and production.
...
- The database schema was changed _without_ using migrations - for example, by using [`prisma db push`](https://docs.prisma.io/docs/orm/reference/prisma-cli-reference#db-push) or manually changing the database schema.

Note

The [shadow database](https://docs.prisma.io/docs/orm/prisma-migrate/understanding-prisma-migrate/shadow-database) is required to detect schema drift, and can therefore only be done in a development environment.
...
See [Prisma Migrate and PgBouncer workaround](https://docs.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections/pgbouncer) for further information and a workaround.
