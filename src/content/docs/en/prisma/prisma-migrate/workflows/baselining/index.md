...
Source URL: https://docs.prisma.io/docs/orm/prisma-migrate/workflows/baselining
...
Baselining is part of [adding Prisma Migrate to a project with an existing database](https://docs.prisma.io/docs/orm/prisma-migrate/getting-started#adding-to-an-existing-project).

This guide **does not apply for MongoDB**.
Instead of `migrate deploy`, [`db push`](https://docs.prisma.io/docs/orm/prisma-migrate/workflows/prototyping-your-schema) is used for [MongoDB](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/mongodb).
...
![A migration history represented by three migration files (file icon and name), surrounded by a a box labelled 'migration history'. The first migration is marked 'do not apply', and the second two migrations are marked 'apply'. An arrow labelled with the command 'prisma migrate deploy' points from the migration history to a database labelled 'production'.](https://docs.prisma.io/docs/img/orm/prisma-migrate/workflows/deploy-db.png?dpl=dpl_8ArR7Q6jiiF8wQkuTbJ4wnxZAnkX)
