...
description: "Prisma Migrate does not currently support the MongoDB connector."
---

Source URL: https://docs.prisma.io/docs/orm/prisma-migrate/understanding-prisma-migrate/limitations-and-known-issues
...
For a simple and integrated way to re-create data when the database is reset, check out our [seeding guide](https://docs.prisma.io/docs/orm/prisma-migrate/workflows/seeding).
