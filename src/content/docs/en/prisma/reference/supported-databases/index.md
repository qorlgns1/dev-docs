...
Source URL: https://docs.prisma.io/docs/orm/reference/supported-databases
...
> See also: [System requirements](https://docs.prisma.io/docs/orm/reference/system-requirements).
