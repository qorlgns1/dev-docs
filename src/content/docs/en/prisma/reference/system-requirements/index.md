...
Source URL: https://docs.prisma.io/docs/orm/reference/system-requirements
...
See also: [Supported database versions](https://docs.prisma.io/docs/orm/reference/supported-databases)
...
Prisma ORM supports macOS 10.15 or newer. There are no additional platform-specific requirements on macOS other than what is listed for all platforms in the [Software requirements](https://docs.prisma.io/docs/orm/reference/system-requirements#software-requirements) section.
...
Upgrade the TypeScript dependency in your project to a [version supported by Prisma ORM](https://docs.prisma.io/docs/orm/reference/system-requirements#software-requirements). `npm install -D typescript`.
