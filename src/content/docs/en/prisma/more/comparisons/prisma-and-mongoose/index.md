...
This page compares the Prisma ORM and [Mongoose](https://mongoosejs.com/docs/guide.html) APIs. If you want to learn how to migrate from Mongoose to Prisma, check out this [guide](https://docs.prisma.io/docs/guides/switch-to-prisma-orm/from-mongoose).
