...
Source URL: https://docs.prisma.io/docs/orm/more/troubleshooting/nextjs
...
- Best practices for monorepo integration
  ...
  - **Use a custom output directory for generated client** : Define a [custom output directory](https://docs.prisma.io/docs/orm/reference/prisma-schema-reference#fields-for-prisma-client-provider) for the generated Prisma Client to maintain consistency across packages.
