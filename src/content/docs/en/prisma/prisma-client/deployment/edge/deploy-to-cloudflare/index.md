...
description: "Learn the things you need to know in order to deploy an app that uses Prisma Client for talking to a database to a Cloudflare Worker or to Cloudflare ..."
---

Source URL: https://docs.prisma.io/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare
...
- [Cloudflare D1](https://docs.prisma.io/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare) is used to access D1 databases
...
If your application uses PostgreSQL, we recommend using [Prisma Postgres](https://docs.prisma.io/docs/postgres). It is fully supported on edge runtimes and does not require a specialized edge-compatible driver. Review the [Prisma Postgres serverless driver limitations](https://docs.prisma.io/docs/postgres/database/serverless-driver#limitations) to understand current constraints.
...
- use the `@prisma/adapter-pg` database adapter (learn more [here](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/postgresql#using-driver-adapters))
...
If you don't have a project to deploy, follow the instructions in the [Prerequisites](https://docs.prisma.io/docs/orm/prisma-client/deployment/edge/deploy-to-cloudflare#prerequisites) to bootstrap a basic Cloudflare Worker with Prisma ORM in it.
...
- use the `@prisma/adapter-planetscale` database adapter (learn more [here](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/mysql#planetscale))
...
- use the `@prisma/adapter-neon` database adapter (learn more [here](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/postgresql#using-driver-adapters))
...
For step-by-step instructions on using Prisma ORM with [Cloudflare D1](https://developers.cloudflare.com/d1/) (schema setup, migrations, and deploying your Worker), see the dedicated [Cloudflare D1 deployment guide](https://docs.prisma.io/docs/guides/deployment/cloudflare-d1).
