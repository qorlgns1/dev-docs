...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/deployment/edge/overview
...
Deploying edge functions that use Prisma ORM on Cloudflare and Vercel is currently in [Preview](https://docs.prisma.io/docs/orm/more/releases#preview).
...
We recommend using [Prisma Postgres](https://docs.prisma.io/docs/postgres). It is fully supported on edge runtimes and does not require a specialized edge-compatible driver.
...
- [Prisma Postgres](https://docs.prisma.io/docs/postgres) is used to access a PostgreSQL database built on bare-metal using unikernels. It is supported on both Cloudflare Workers and Vercel.
...
You can use all of these drivers with Prisma ORM using the respective [driver adapters](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/database-drivers).
...
If you want to deploy an app using Turso, you can follow the instructions [here](https://docs.prisma.io/docs/orm/core-concepts/supported-databases/sqlite#using-driver-adapters).
