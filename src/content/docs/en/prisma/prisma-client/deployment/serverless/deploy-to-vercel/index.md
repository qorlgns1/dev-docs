...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/deployment/serverless/deploy-to-vercel
...
In a more sophisticated CI/CD environment, you may additionally want to update the database schema with any migrations you have performed during local development. You can do this using the [`prisma migrate deploy`](https://docs.prisma.io/docs/orm/reference/prisma-cli-reference#migrate-deploy) command.
...
![Add an environment variable for the preview environment](https://docs.prisma.io/docs/img/orm/prisma-client/deployment/serverless/images/300-60-deploy-to-vercel-preview-environment-variable.png?dpl=dpl_8ArR7Q6jiiF8wQkuTbJ4wnxZAnkX)
...
You can use [Prisma Postgres](https://docs.prisma.io/docs/postgres), which has built-in connection pooling, to reduce your Prisma Client bundle size, and to avoid cold starts.

For more information on connection management for serverless environments, refer to our [connection management guide](https://docs.prisma.io/docs/orm/prisma-client/setup-and-configuration/databases-connections#serverless-environments-faas).
