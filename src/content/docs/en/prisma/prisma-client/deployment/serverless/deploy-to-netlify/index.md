...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/deployment/serverless/deploy-to-netlify
...
2. Click **Site settings** : ![Netlify admin UI](https://docs.prisma.io/docs/img/orm/prisma-client/deployment/serverless/images/500-06-deploy-to-netlify-site-settings.png?dpl=dpl_8ArR7Q6jiiF8wQkuTbJ4wnxZAnkX)
3. Navigate to **Build & deploy** in the sidebar on the left and select **Environment**.
4. Click **Edit variables** and create a variable with the key `DATABASE_URL` and set its value to your database connection string. ![Netlify environment variables](https://docs.prisma.io/docs/img/orm/prisma-client/deployment/serverless/images/500-07-deploy-to-netlify-environment-variables-settings.png?dpl=dpl_8ArR7Q6jiiF8wQkuTbJ4wnxZAnkX)
5. Click **Save**.
