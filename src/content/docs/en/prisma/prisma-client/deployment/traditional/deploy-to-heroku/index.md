...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/deployment/traditional/deploy-to-heroku

# Deploy to Heroku

Learn how to deploy a Node.js server that uses Prisma ORM to Heroku
...
![Heroku deployment architecture diagram showing a Node.js backend with Prisma Client, static frontend, and PostgreSQL database.](https://docs.prisma.io/docs/img/orm/prisma-client/deployment/traditional/images/heroku-architecture.png?dpl=dpl_8ArR7Q6jiiF8wQkuTbJ4wnxZAnkX)
...
In this guide, you will use [Prisma Migrate](https://docs.prisma.io/docs/orm/prisma-migrate) to create the database schema. Prisma Migrate is based on the Prisma schema and works by generating `.sql` migration files that are executed against the database.
...
![Deployed Prisma app frontend in browser showing Check API status, Seed data, and Load feed buttons.](https://docs.prisma.io/docs/img/orm/prisma-client/deployment/traditional/images/heroku-deployed.png?dpl=dpl_8ArR7Q6jiiF8wQkuTbJ4wnxZAnkX)
