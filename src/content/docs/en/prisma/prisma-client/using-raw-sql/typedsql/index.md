...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/using-raw-sql/typedsql
...
See below for information on how to [define argument types in your SQL files](https://docs.prisma.io/docs/orm/prisma-client/using-raw-sql/typedsql#defining-argument-types-in-your-sql-files).
...
Taking the [example from above](https://docs.prisma.io/docs/orm/prisma-client/using-raw-sql/typedsql#passing-arguments-to-typedsql-queries), the SQL file would look like this:
...
TypedSQL supports modern versions of MySQL and PostgreSQL without any further configuration. For MySQL versions older than 8.0 and all SQLite versions, you will need to manually [describe argument types](https://docs.prisma.io/docs/orm/prisma-client/using-raw-sql/typedsql#defining-argument-types-in-your-sql-files) in your SQL files. The types of inputs are inferred in all supported versions of PostgreSQL and MySQL 8.0 and later.
...
In this example, the columns to be selected are defined dynamically and included in the SQL query. While this approach provides flexibility, it requires careful attention to security, particularly to [avoid SQL injection vulnerabilities](https://docs.prisma.io/docs/orm/prisma-client/using-raw-sql/raw-queries#sql-injection-prevention). Additionally, using raw SQL queries means foregoing the type-safety and DX of TypedSQL.
