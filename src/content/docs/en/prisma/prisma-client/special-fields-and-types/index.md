...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types
...
When creating records that have fields of type [`DateTime`](https://docs.prisma.io/docs/orm/reference/prisma-schema-reference#datetime), Prisma Client accepts values as [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) objects adhering to the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) standard.
