...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types

# Composite types

Work with composite types and embedded documents in MongoDB

Composite types are only available with MongoDB.

[Composite types](https://docs.prisma.io/docs/orm/prisma-schema/data-model/models), known as [embedded documents](https://www.mongodb.com/docs/manual/data-modeling/#embedded-data) in MongoDB, allow you to embed records within other records.

This page explains how to:

- [find](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#finding-records-that-contain-composite-types-with-find-and-findmany) records that contain composite types using `findFirst` and `findMany`
- [create](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#creating-records-with-composite-types-using-create-and-createmany) new records with composite types using `create` and `createMany`
- [update](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#changing-composite-types-within-update-and-updatemany) composite types within existing records using `update` and `updateMany`
- [delete](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#deleting-records-that-contain-composite-types-with-delete-and-deletemany) records with composite types using `delete` and `deleteMany`
...
- A field on the composite type is [required](https://docs.prisma.io/docs/orm/prisma-schema/data-model/models#optional-and-mandatory-fields), and
- this field has a [default value](https://docs.prisma.io/docs/orm/prisma-schema/data-model/models#defining-a-default-value), and
- this field is not present in the returned document or documents.

Note:

- This is the same behavior as with [model fields](https://docs.prisma.io/docs/orm/reference/prisma-schema-reference#model-field-scalar-types).
...
Suppose that you then run `npx prisma db push` to [update your database](https://docs.prisma.io/docs/orm/reference/prisma-cli-reference#db-push) and regenerate your Prisma Client with `npx prisma generate`. Then, you run the following application code:
...
When you create a record with a composite type that has a unique constraint, note that MongoDB does not enforce unique values inside a record. [Learn more](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#duplicate-values-in-unique-fields-of-composite-types).
...
When you update a record with a composite type that has a unique constraint, note that MongoDB does not enforce unique values inside a record. [Learn more](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#duplicate-values-in-unique-fields-of-composite-types).
...
When you create or update the values in a composite type that has a unique constraint, note that MongoDB does not enforce unique values inside a record. [Learn more](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#duplicate-values-in-unique-fields-of-composite-types).
...
You can also use [filters](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#finding-records-that-contain-composite-types-with-find-and-findmany) to delete records that match a composite type. The example below uses the `some` filter to delete products that contain a certain photo:
...
Note that you can [use Prisma ORM relations to work around this issue](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/composite-types#use-prisma-orm-relations-to-enforce-unique-values-in-a-record).
...
In the example above, MongoDB did not enforce the unique constraint on a nested address name. However, you can model your data differently to enforce unique values in a record. To do so, use Prisma ORM [relations](https://docs.prisma.io/docs/orm/prisma-schema/data-model/relations) to turn the composite type into a collection. Set a relationship to this collection and place a unique constraint on the field that you want to be unique.
