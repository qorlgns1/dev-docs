...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/null-and-undefined
...
For documentation on the current behavior (without the `strictUndefinedChecks` Preview feature) see [current behavior](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/null-and-undefined#current-behavior).
...
This is particularly important to account for in [a **Prisma ORM with GraphQL context** , where `null` and `undefined` are interchangeable](https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/null-and-undefined#null-and-undefined-in-a-graphql-resolver).
...
This example shows how an `undefined` parameter impacts the results returned by a query that uses the [`OR`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference#or) operator.
...
This is in contrast to the [`AND`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference#and) and [`NOT`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference) operators, which will both return all the users if you pass in an `undefined` value.
