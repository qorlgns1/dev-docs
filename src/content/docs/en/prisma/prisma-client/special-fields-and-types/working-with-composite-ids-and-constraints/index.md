...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/special-fields-and-types/working-with-composite-ids-and-constraints

# Working with compound IDs and unique constraints

How to read, write, and filter by compound IDs and unique constraints

Composite IDs and compound unique constraints can be defined in your Prisma schema using the [`@@id`](https://docs.prisma.io/docs/orm/reference/prisma-schema-reference) and [`@@unique`](https://docs.prisma.io/docs/orm/reference/prisma-schema-reference) attributes.
