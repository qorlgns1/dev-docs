...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/testing/integration-testing
...
See our [system requirements](https://docs.prisma.io/docs/orm/reference/system-requirements) for all minimum version requirements.
...
The guide uses a singleton pattern for Prisma Client setup. Refer to the [singleton](https://docs.prisma.io/docs/orm/prisma-client/testing/unit-testing#singleton) docs for a walk through of how to set that up.

## Add Docker to your project

![Docker compose code pointing towards image of container holding a Postgres database](https://docs.prisma.io/docs/img/orm/prisma-client/testing/Docker_Diagram_V1.png?dpl=dpl_8ArR7Q6jiiF8wQkuTbJ4wnxZAnkX)
...
The above `.env.test` file is used as part of a multiple `.env` file setup. Checkout the [using multiple .env files.](https://docs.prisma.io/docs/orm/more/dev-environment/environment-variables) section to learn more about setting up your project with multiple `.env` files
...
Before the test suite is run the database is seeded with data. After the test suite has finished a [`deleteMany`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference#deletemany) is used to clear the database of its data.
...
However, this doesn't scale as well as having a more generic solution that maps over your models and performs a truncate on them. For those scenarios and examples of using raw SQL queries see [Deleting all data with raw SQL / `TRUNCATE`](https://docs.prisma.io/docs/orm/prisma-client/queries/crud#deleting-all-data-with-raw-sql--truncate)
