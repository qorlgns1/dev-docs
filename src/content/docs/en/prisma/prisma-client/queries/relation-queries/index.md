...
- [Create](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries#create) \- Insert records
- [Read](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries#read) \- Query records
- [Update](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries#update) \- Modify records
- [Delete](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries#delete) \- Remove records

See the [Prisma Client API reference](https://docs.prisma.io/docs/orm/reference/prisma-client-reference) for detailed method documentation.
...
See [Nested writes](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries#nested-writes) for creating records with relations.
...
See [Filtering and sorting](https://docs.prisma.io/docs/v6/orm/prisma-client/queries/filtering-and-sorting) for more examples.
...
See [Select fields](https://docs.prisma.io/docs/v6/orm/prisma-client/queries/select-fields) and [Relation queries](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries) for more.
...
See [Relation queries](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries) for connecting and disconnecting related records.

## Delete\n

- Delete a single record

The following query uses [`delete()`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference#delete) to delete a single `User` record:
...
Attempting to delete a user with one or more posts result in an error, as every `Post` requires an author - see [cascading deletes](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries#cascading-deletes-deleting-related-records).

- Delete multiple records

The following query uses [`deleteMany()`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference#deletemany) to delete all `User` records where `email` contains `prisma.io`:
...
The following query uses [`deleteMany()`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference#deletemany) to delete all `User` records:

```
    const deleteUsers = await prisma.user.deleteMany({});
```

Be aware that this query will fail if the user has any related records (such as posts). In this case, you need to [delete the related records first](https://docs.prisma.io/docs/orm/prisma-client/queries/relation-queries#cascading-deletes-deleting-related-records).

- Cascading deletes (deleting related records)

You can configure cascading deletes using [referential actions](https://docs.prisma.io/docs/orm/prisma-schema/data-model/relations/referential-actions).
...
When you know the order in which your tables should be deleted, you can use the [`deleteMany`](https://docs.prisma.io/docs/orm/reference/prisma-client-reference#deletemany) function. This is executed synchronously in a [`$transaction`](https://docs.prisma.io/docs/orm/prisma-client/queries/transactions) and can be used with all types of databases.
...
If you are comfortable working with raw SQL, you can perform a `TRUNCATE` query on a table using [`$executeRawUnsafe`](https://docs.prisma.io/docs/orm/prisma-client/using-raw-sql/raw-queries#executerawunsafe).
