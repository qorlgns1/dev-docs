...
Source URL: https://docs.prisma.io/docs/orm/prisma-client/queries/crud
...
- [Create](https://docs.prisma.io/docs/orm/prisma-client/queries/crud#create) \- Insert records
- [Read](https://docs.prisma.io/docs/orm/prisma-client/queries/crud#read) \- Query records
- [Update](https://docs.prisma.io/docs/orm/prisma-client/queries/crud#update) \- Modify records
- [Delete](https://docs.prisma.io/docs/orm/prisma-client/queries/crud#delete) \- Remove records
...
Attempting to delete a user with one or more posts result in an error, as every `Post` requires an author - see [cascading deletes](https://docs.prisma.io/docs/orm/prisma-client/queries/crud#cascading-deletes-deleting-related-records).
...
Be aware that this query will fail if the user has any related records (such as posts). In this case, you need to [delete the related records first](https://docs.prisma.io/docs/orm/prisma-client/queries/crud#cascading-deletes-deleting-related-records).
