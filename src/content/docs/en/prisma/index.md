...
- [**Prisma Client**](https://docs.prisma.io/docs/orm/prisma-client/setup-and-configuration/introduction): Auto-generated, type-safe **ORM interface**
- [**Prisma Migrate**](https://docs.prisma.io/docs/orm/prisma-migrate): Database migration system
...
The [Prisma schema](https://docs.prisma.io/docs/orm/prisma-schema/overview) defines your data models and database connection:
...
Use [Prisma Migrate](https://docs.prisma.io/docs/orm/prisma-migrate) to create and apply migrations:
...
Or [introspect](https://docs.prisma.io/docs/orm/prisma-schema/introspection) an existing database:
...
- [**Prisma schema**](https://docs.prisma.io/docs/orm/prisma-schema/overview) \- Learn the schema language
- [**Prisma Client**](https://docs.prisma.io/docs/orm/prisma-client/setup-and-configuration/introduction) \- Explore the query API
