...
### [Cypress로 테스트하기](https://next-auth.js.org/tutorials/testing-with-cypress)[​](https://next-auth.js.org/guides/testing#testing-with-cypress "헤딩으로 바로 가는 링크")

- Cypress를 사용해 테스트를 작성하는 방법.
