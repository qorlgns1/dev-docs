...
## Next.js란 무엇인가?[](https://nextjs.org/docs#what-is-nextjs)
...
## 문서 활용 방법[](https://nextjs.org/docs#how-to-use-the-docs)

문서는 세 가지 섹션으로 구성되어 있습니다:

  * [Getting Started](https://nextjs.org/docs/app/getting-started): 새 애플리케이션을 만들고 핵심 Next.js 기능을 학습할 수 있는 단계별 튜토리얼.
...
### React 버전 처리[](https://nextjs.org/docs#react-version-handling)

App Router와 Pages Router는 React 버전을 다르게 처리합니다:

  * **App Router** : 새 React 릴리스 전에 프레임워크에서 검증되고 안정적인 React 19 변경 사항과 최신 기능을 포함하는 [React canary 릴리스](https://react.dev/blog/2023/05/03/react-canaries)를 기본으로 사용합니다.
...
## 접근성[](https://nextjs.org/docs#accessibility)

스크린 리더 사용 시 최적의 경험을 위해 Firefox와 NVDA, 또는 Safari와 VoiceOver 조합을 권장합니다.

## 커뮤니티에 참여하세요[](https://nextjs.org/docs#join-our-community)

Next.js 관련 질문이 있다면 언제든지 [GitHub Discussions](https://github.com/vercel/next.js/discussions), [Discord](https://discord.com/invite/bUG2bvbtHy), [X (Twitter)](https://x.com/nextjs), [Reddit](https://www.reddit.com/r/nextjs) 커뮤니티에 문의하세요.
