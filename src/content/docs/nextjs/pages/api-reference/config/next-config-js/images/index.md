---
title: 'next.config.js 옵션: images'
description: '최종 업데이트: 2026년 2월 20일'
---

# next.config.js 옵션: images | Next.js

출처 URL: https://nextjs.org/docs/pages/api-reference/config/next-config-js/images

[구성](https://nextjs.org/docs/pages/api-reference/config)[next.config.js 옵션](https://nextjs.org/docs/pages/api-reference/config/next-config-js)images
...
Next.js 기본 Image Optimization API 대신 클라우드 제공자를 사용해 이미지를 최적화하려면 다음과 같이 `next.config.js`를 구성하면 됩니다.
...
이 `loaderFile`은 Next.js 애플리케이션 루트를 기준으로 한 파일을 가리켜야 합니다. 해당 파일은 문자열을 반환하는 기본 함수를 export 해야 하며, 예시는 다음과 같습니다.
...
또는 [`loader` prop](https://nextjs.org/docs/pages/api-reference/components/image#loader)을 사용해 함수를 각 `next/image` 인스턴스에 전달할 수도 있습니다.

내장 [Image Optimization API](https://nextjs.org/docs/pages/api-reference/components/image)와 [Image Component](https://nextjs.org/docs/pages/api-reference/components/image)의 동작을 구성하는 방법을 더 알아보려면 사용 가능한 옵션이 정리된 [Image Configuration Options](https://nextjs.org/docs/pages/api-reference/components/image#configuration-options)를 확인하세요.

## 로더 구성 예시[](https://nextjs.org/docs/pages/api-reference/config/next-config-js/images#example-loader-configuration)
