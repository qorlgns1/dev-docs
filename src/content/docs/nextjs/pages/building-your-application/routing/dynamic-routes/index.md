...
### [Linking and NavigatingNext.js에서 내비게이션이 어떻게 동작하는지, Link 컴포넌트와 `useRouter` 훅을 사용하는 방법을 알아보세요.](https://nextjs.org/docs/pages/building-your-application/routing/linking-and-navigating)### [useRouterNext.js Router API를 더 깊이 이해하고, 페이지에서 useRouter 훅으로 라우터 인스턴스에 접근하는 방법을 확인하세요.](https://nextjs.org/docs/pages/api-reference/functions/use-router)
