---
title: 'next.config.js: appDir'
description: '이것은 레거시 API이며 더 이상 권장되지 않습니다. 하위 호환성을 위해 계속 지원됩니다.'
---
...
> **알아두면 좋아요** : Next.js 13.4부터 이 옵션은 **더 이상** 필요하지 않습니다. App Router가 이제 안정화되었습니다.
