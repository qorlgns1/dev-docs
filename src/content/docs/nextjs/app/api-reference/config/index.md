...
- [개요](https://nextjs.org/docs/app/api-reference/config/next-config-js)
  - next.config.jsnext.config.js로 애플리케이션을 구성하는 방법을 알아보세요.
...
- [ESLint](https://nextjs.org/docs/app/api-reference/config/eslint)
  - Next.js 애플리케이션에서 일반적인 문제를 포착하도록 ESLint 플러그인을 사용하고 구성하는 방법을 알아보세요.
