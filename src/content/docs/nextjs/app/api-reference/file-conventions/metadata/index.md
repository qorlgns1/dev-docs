...
### [favicon, icon, and apple-icon 파일 규칙을 위한 API Reference.](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/app-icons)### [manifest.json 파일을 위한 API Reference.](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/manifest)### [Open Graph Image과 Twitter Image 파일 규칙을 위한 API Reference.](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/opengraph-image)### [robots.txt 파일을 위한 API Reference.](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/robots)### [sitemap.xml 파일을 위한 API Reference.](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/sitemap)
