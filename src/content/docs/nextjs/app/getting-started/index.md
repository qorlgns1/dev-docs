...
## 사전 지식[](https://nextjs.org/docs/app/getting-started#pre-requisite-knowledge)
...
React가 처음이거나 복습이 필요하다면, [React Foundations 과정](https://nextjs.org/learn/react-foundations)과 학습과 동시에 애플리케이션을 만들어 보는 [Next.js Foundations 과정](https://nextjs.org/learn/dashboard-app)을 먼저 살펴보세요.

## 다음 단계[](https://nextjs.org/docs/app/getting-started#next-steps)

- [설치](https://nextjs.org/docs/app/getting-started/installation)
...
- [레이아웃과 페이지](https://nextjs.org/docs/app/getting-started/layouts-and-pages)
...
- [서버와 클라이언트 컴포넌트](https://nextjs.org/docs/app/getting-started/server-and-client-components)
...
- [데이터 업데이트](https://nextjs.org/docs/app/getting-started/updating-data)
  - Server Functions와 Server Actions를 사용해 데이터를 변경하는 방법을 배우세요.
- [캐싱과 재검증](https://nextjs.org/docs/app/getting-started/caching-and-revalidating)
...
- [이미지 최적화](https://nextjs.org/docs/app/getting-started/images)
  - Next.js에서 이미지를 최적화하는 방법을 배우세요.
- [폰트 최적화](https://nextjs.org/docs/app/getting-started/fonts)
  - Next.js에서 폰트를 최적화하는 방법을 알아보세요.
- [메타데이터와 OG 이미지](https://nextjs.org/docs/app/getting-started/metadata-and-og-images)
  - 페이지에 메타데이터를 추가하고 동적 OG 이미지를 만드는 방법을 익히세요.
- [라우트 핸들러](https://nextjs.org/docs/app/getting-started/route-handlers)
  - Route Handlers를 사용하는 방법을 배우세요.
- [프록시](https://nextjs.org/docs/app/getting-started/proxy)
  - Proxy를 사용하는 방법을 알아보세요.
- [배포](https://nextjs.org/docs/app/getting-started/deploying)
  - Next.js 애플리케이션을 배포하는 방법을 익히세요.
- [업그레이드](https://nextjs.org/docs/app/getting-started/upgrading)
