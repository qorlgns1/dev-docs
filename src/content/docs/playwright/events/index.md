---
title: "Events"
description: "Playwright allows listening to various types of events happening on the web page, such as network requests, creation of child pages, dedicated workers..."
---

Source URL: https://playwright.dev/docs/events

# Events | Playwright

## Introduction[​](https://playwright.dev/docs/events#introduction "Direct link to Introduction")
...
## Waiting for event[​](https://playwright.dev/docs/events#waiting-for-event "Direct link to Waiting for event")
...
Wait for a request with the specified url using [page.waitForRequest()](https://playwright.dev/docs/api/class-page#page-wait-for-request):
...
## Adding/removing event listener[​](https://playwright.dev/docs/events#addingremoving-event-listener "Direct link to Adding/removing event listener")
...
## Adding one-off listeners[​](https://playwright.dev/docs/events#adding-one-off-listeners "Direct link to Adding one-off listeners")
