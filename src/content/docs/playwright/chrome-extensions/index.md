...
description: "Extensions only work in Chromium when launched with a persistent context. Use custom browser args at your own risk, as some of them may break Playwrig..."
---

Source URL: https://playwright.dev/docs/chrome-extensions

# Chrome extensions | Playwright

## Introduction[​](https://playwright.dev/docs/chrome-extensions#introduction "Direct link to Introduction")
...
## Testing[​](https://playwright.dev/docs/chrome-extensions#testing "Direct link to Testing")
