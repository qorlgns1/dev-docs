---
title: "Route"
description: "Whenever a network route is set up with page.route() or browserContext.route(), the  object allows to handle the route."
---

Source URL: https://playwright.dev/docs/api/class-route
...
To set custom cookies, use [browserContext.addCookies()](https://playwright.dev/docs/api/class-browsercontext#browser-context-add-cookies).
