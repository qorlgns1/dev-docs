...
description: "Playwright can generate tests automatically, providing a quick way to get started with testing. Codegen opens a browser window for interaction and the..."
---

Source URL: https://playwright.dev/docs/codegen-intro
...
##### [​](https://playwright.dev/docs/codegen-intro#-1 "Direct link to -1")
...
##### [​](https://playwright.dev/docs/codegen-intro#-2 "Direct link to -2")
