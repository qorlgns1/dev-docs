...
description: "Playwright is available in multiple languages that share the same underlying implementation. All core features for automating the browser are supporte..."
---
...
## Introduction[​](https://playwright.dev/docs/languages#introduction "Direct link to Introduction")
...
## JavaScript and TypeScript[​](https://playwright.dev/docs/languages#javascript-and-typescript "Direct link to JavaScript and TypeScript")
...
## Python[​](https://playwright.dev/docs/languages#python "Direct link to Python")
...
## Java[​](https://playwright.dev/docs/languages#java "Direct link to Java")
...
## .NET[​](https://playwright.dev/docs/languages#net "Direct link to .NET")
