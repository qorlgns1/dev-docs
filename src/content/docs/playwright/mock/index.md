---
title: "Mock APIs"
description: "Web APIs are usually implemented as HTTP endpoints. Playwright provides APIs to mock and modify network traffic, both HTTP and HTTPS. Any requests tha..."
---

Source URL: https://playwright.dev/docs/mock

# Mock APIs | Playwright

## Introduction[​](https://playwright.dev/docs/mock#introduction "Direct link to Introduction")
...
## Mock API requests[​](https://playwright.dev/docs/mock#mock-api-requests "Direct link to Mock API requests")
...
## Modify API responses[​](https://playwright.dev/docs/mock#modify-api-responses "Direct link to Modify API responses")
...
## Mocking with HAR files[​](https://playwright.dev/docs/mock#mocking-with-har-files "Direct link to Mocking with HAR files")
...
### Recording a HAR file[​](https://playwright.dev/docs/mock#recording-a-har-file "Direct link to Recording a HAR file")
...
Alternatively, you can also record HAR files by using the [recordHar](https://playwright.dev/docs/api/class-browser#browser-new-context-option-record-har) option in [browser.newContext()](https://playwright.dev/docs/api/class-browser#browser-new-context) when creating a browser context. This allows you to capture all network traffic for the entire context until the context is closed.

### Modifying a HAR file[​](https://playwright.dev/docs/mock#modifying-a-har-file "Direct link to Modifying a HAR file")
...
### Replaying from HAR[​](https://playwright.dev/docs/mock#replaying-from-har "Direct link to Replaying from HAR")
...
#### Recording HAR with CLI[​](https://playwright.dev/docs/mock#recording-har-with-cli "Direct link to Recording HAR with CLI")
...
## Mock WebSockets[​](https://playwright.dev/docs/mock#mock-websockets "Direct link to Mock WebSockets")
...
For more details, see [WebSocketRoute](https://playwright.dev/docs/api/class-websocketroute "WebSocketRoute").
