...
description: "The Playwright VS Code extension brings the power of Playwright Test directly into your editor, allowing you to run, debug, and generate tests with a ..."
---

Source URL: https://playwright.dev/docs/getting-started-vscode

# Getting started - VS Code | Playwright

## Introduction[​](https://playwright.dev/docs/getting-started-vscode#introduction "Direct link to Introduction")
...
## Prerequisites[​](https://playwright.dev/docs/getting-started-vscode#prerequisites "Direct link to Prerequisites")
...
## Getting Started[​](https://playwright.dev/docs/getting-started-vscode#getting-started "Direct link to Getting Started")

### Installation & Setup[​](https://playwright.dev/docs/getting-started-vscode#installation--setup "Direct link to Installation & Setup")
...
### Opening the Testing Sidebar[​](https://playwright.dev/docs/getting-started-vscode#opening-the-testing-sidebar "Direct link to Opening the Testing Sidebar")
...
## Core Features[​](https://playwright.dev/docs/getting-started-vscode#core-features "Direct link to Core Features")

### Running Your Tests[​](https://playwright.dev/docs/getting-started-vscode#running-your-tests "Direct link to Running Your Tests")
...
### Debugging Your Tests[​](https://playwright.dev/docs/getting-started-vscode#debugging-your-tests "Direct link to Debugging Your Tests")
...
To learn more, see our [Trace Viewer guide](https://playwright.dev/docs/trace-viewer).

### Generating Tests with CodeGen[​](https://playwright.dev/docs/getting-started-vscode#generating-tests-with-codegen "Direct link to Generating Tests with CodeGen")
...
To learn more, see our [CodeGen guide](https://playwright.dev/docs/codegen).

## Advanced Features[​](https://playwright.dev/docs/getting-started-vscode#advanced-features "Direct link to Advanced Features")

### Project Dependencies[​](https://playwright.dev/docs/getting-started-vscode#project-dependencies "Direct link to Project Dependencies")

Use [project dependencies](https://playwright.dev/docs/test-projects) to define setup tests that run before other tests. For example, you can create a login test that runs first, then reuse that authenticated state across multiple tests without having to log in again for each test. In VS Code, you can see these setup tests in the Test Explorer and run them independently when needed.

![setup tests in vscode](https://playwright.dev/assets/images/setup-tests-8c128d60e165d9cbf13e0bdd3eb5c411.png)

To learn more, see our [Project Dependencies guide](https://playwright.dev/docs/test-projects).

### Global Setup[​](https://playwright.dev/docs/getting-started-vscode#global-setup "Direct link to Global Setup")
...
### Multiple Configurations[​](https://playwright.dev/docs/getting-started-vscode#multiple-configurations "Direct link to Multiple Configurations")
...
## Quick Reference[​](https://playwright.dev/docs/getting-started-vscode#quick-reference "Direct link to Quick Reference")
...
## What's Next[​](https://playwright.dev/docs/getting-started-vscode#whats-next "Direct link to What's Next")

- [Write tests using web-first assertions, page fixtures, and locators](https://playwright.dev/docs/writing-tests)
- [Run your tests on CI](https://playwright.dev/docs/ci-intro)
