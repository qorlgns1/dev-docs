---
title: "Browsers"
description: "Each version of Playwright needs specific versions of browser binaries to operate. You will need to use the Playwright CLI to install these browsers."
---

Source URL: https://playwright.dev/docs/browsers

# Browsers | Playwright

## Introduction[​](https://playwright.dev/docs/browsers#introduction "Direct link to Introduction")

Each version of Playwright needs specific versions of browser binaries to operate. You will need to use the Playwright CLI to install these browsers.

With every release, Playwright updates the versions of the browsers it supports, so that the latest Playwright would support the latest browsers at any moment. It means that every time you update Playwright, you might need to re-run the `install` CLI command.

## Install browsers[​](https://playwright.dev/docs/browsers#install-browsers "Direct link to Install browsers")
...
## Install system dependencies[​](https://playwright.dev/docs/browsers#install-system-dependencies "Direct link to Install system dependencies")
...
## Update Playwright regularly[​](https://playwright.dev/docs/browsers#update-playwright-regularly "Direct link to Update Playwright regularly")
...
## Configure Browsers[​](https://playwright.dev/docs/browsers#configure-browsers "Direct link to Configure Browsers")
...
### Run tests on different browsers[​](https://playwright.dev/docs/browsers#run-tests-on-different-browsers "Direct link to Run tests on different browsers")
...
![Projects section in VS Code extension](https://playwright.dev/assets/images/vscode-projects-section-70d5aa3cdca55c2ab82a8fc0c493a87d.png)
...
### Chromium[​](https://playwright.dev/docs/browsers#chromium "Direct link to Chromium")

For Google Chrome, Microsoft Edge and other Chromium-based browsers, by default, Playwright uses open source Chromium builds. Since the Chromium project is ahead of the branded browsers, when the world is on Google Chrome N, Playwright already supports Chromium N+1 that will be released in Google Chrome and Microsoft Edge a few weeks later.

### Chromium: headless shell[​](https://playwright.dev/docs/browsers#chromium-headless-shell "Direct link to Chromium: headless shell")
...
### Chromium: new headless mode[​](https://playwright.dev/docs/browsers#chromium-new-headless-mode "Direct link to Chromium: new headless mode")
...
### Google Chrome & Microsoft Edge[​](https://playwright.dev/docs/browsers#google-chrome--microsoft-edge "Direct link to Google Chrome & Microsoft Edge")
...
#### Installing Google Chrome & Microsoft Edge[​](https://playwright.dev/docs/browsers#installing-google-chrome--microsoft-edge "Direct link to Installing Google Chrome & Microsoft Edge")
...
#### When to use Google Chrome & Microsoft Edge and when not to?[​](https://playwright.dev/docs/browsers#when-to-use-google-chrome--microsoft-edge-and-when-not-to "Direct link to When to use Google Chrome & Microsoft Edge and when not to?")

##### Defaults[​](https://playwright.dev/docs/browsers#defaults "Direct link to Defaults")
...
##### Regression testing[​](https://playwright.dev/docs/browsers#regression-testing "Direct link to Regression testing")
...
##### Media codecs[​](https://playwright.dev/docs/browsers#media-codecs "Direct link to Media codecs")
...
##### Enterprise policy[​](https://playwright.dev/docs/browsers#enterprise-policy "Direct link to Enterprise policy")
...
### Firefox[​](https://playwright.dev/docs/browsers#firefox "Direct link to Firefox")
...
### WebKit[​](https://playwright.dev/docs/browsers#webkit "Direct link to WebKit")
...
## Install behind a firewall or a proxy[​](https://playwright.dev/docs/browsers#install-behind-a-firewall-or-a-proxy "Direct link to Install behind a firewall or a proxy")
...
If you are [installing dependencies](https://playwright.dev/docs/browsers#install-system-dependencies) and need to use a proxy on Linux, make sure to run the command as a root user. Otherwise, Playwright will attempt to become a root and will not pass environment variables like `HTTPS_PROXY` to the linux package manager.
...
## Download from artifact repository[​](https://playwright.dev/docs/browsers#download-from-artifact-repository "Direct link to Download from artifact repository")
...
## Managing browser binaries[​](https://playwright.dev/docs/browsers#managing-browser-binaries "Direct link to Managing browser binaries")
...
### Hermetic install[​](https://playwright.dev/docs/browsers#hermetic-install "Direct link to Hermetic install")
...
### Stale browser removal[​](https://playwright.dev/docs/browsers#stale-browser-removal "Direct link to Stale browser removal")
...
### List all installed browsers:[​](https://playwright.dev/docs/browsers#list-all-installed-browsers "Direct link to List all installed browsers:")
...
### Uninstall browsers[​](https://playwright.dev/docs/browsers#uninstall-browsers "Direct link to Uninstall browsers")
