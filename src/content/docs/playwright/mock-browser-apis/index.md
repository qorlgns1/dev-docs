...
description: "Playwright provides native support for most of the browser features. However, there are some experimental APIs and APIs which are not (yet) fully supp..."
---

Source URL: https://playwright.dev/docs/mock-browser-apis

# Mock browser APIs | Playwright

## Introduction[​](https://playwright.dev/docs/mock-browser-apis#introduction "Direct link to Introduction")
...
## Creating mocks[​](https://playwright.dev/docs/mock-browser-apis#creating-mocks "Direct link to Creating mocks")

Since the page may be calling the API very early while loading it's important to setup all the mocks before the page started loading. The easiest way to achieve that is to call [page.addInitScript()](https://playwright.dev/docs/api/class-page#page-add-init-script):
...
## Mocking read-only APIs[​](https://playwright.dev/docs/mock-browser-apis#mocking-read-only-apis "Direct link to Mocking read-only APIs")
...
## Verifying API calls[​](https://playwright.dev/docs/mock-browser-apis#verifying-api-calls "Direct link to Verifying API calls")

Sometimes it is useful to check if the page made all expected APIs calls. You can record all API method invocations and then compare them with golden result. [page.exposeFunction()](https://playwright.dev/docs/api/class-page#page-expose-function) may come in handy for passing message from the page back to the test code:
...
## Updating mock[​](https://playwright.dev/docs/mock-browser-apis#updating-mock "Direct link to Updating mock")
